...
Contact me on X <a href="https://x.com/sdrzn" target="_blank">@sdrzn</a>. Please create an <a href="https://github.com/saoudrizwan/claude-dev/issues">issue</a> if you come across a bug, or use the <a href="https://github.com/saoudrizwan/claude-dev/discussions/categories/feature-requests">feature request board</a> to share & vote on new features.
