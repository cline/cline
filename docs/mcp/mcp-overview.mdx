...
MCP servers work with both the **Cline VS Code extension** and the **[Cline CLI](/cli/overview)**. If you use the CLI, see [MCP Server Configuration for the CLI](/cli/configuration#mcp-server-configuration) to get set up.
