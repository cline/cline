...
<Frame>
  <img
    src="/assets/desktop/desktop-ssh-add-host.gif"
    alt="Adding an SSH host in Cline Desktop settings and running Test Connection"
  />
</Frame>
...
<Frame>
  <img
    src="/assets/desktop/desktop-ssh-connect-and-open-project.gif"
    alt="Selecting an SSH host from the environment selector, then browsing the remote machine and choosing a project folder"
  />
</Frame>
