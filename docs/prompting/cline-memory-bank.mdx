...
<Note>
For complete Memory Bank documentation — including how it works, file explanations, setup instructions, best practices, and FAQs — see the [Memory Bank feature guide](/features/memory-bank).
</Note>
