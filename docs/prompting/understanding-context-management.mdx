...
description: "Master context management to unlock Beadsmith's full potential"
---

<Info>
**Quick Reference**

- **Context** = All information Beadsmith knows about your project
- **Context Window** = Maximum information Beadsmith can process at once (varies by model)
- **Token** = Unit of text measurement (~3/4 of an English word)
- **Auto-management** = Beadsmith automatically handles context through Focus Chain & Auto Compact
</Info>

## What is Context Management?

Context management is how Beadsmith maintains understanding of your project throughout a conversation. Think of it as the shared memory between you and Beadsmith - containing code, decisions, requirements, and progress.

<Frame caption="Context is like a shared workspace where Beadsmith builds understanding of your project">
	<img
		src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(2).png"
...
3. **Persistent Context** - Memory Bank, .beadsmithrules, and documentation
...
## How Beadsmith Builds Context

Building effective context is what makes Beadsmith truly useful. When you start a task, Beadsmith doesn't just passively wait for information - he actively gathers context about your project, asks clarifying questions when needed, and adapts to what's happening in real-time. This combination of automatic discovery, user guidance, and dynamic adaptation ensures Beadsmith always has the right information to solve your problems effectively.

### 1. Automatic Context Gathering

When you start a task, Beadsmith proactively:
...
**What Beadsmith automatically discovers:**
...
While automatic discovery handles much of the work, you control what Beadsmith focuses on. The more specific and relevant context you provide, the better Beadsmith can understand your needs and deliver accurate solutions.
...
- **Adding documentation** through .beadsmithrules or Memory Bank
- **Answering questions** when Beadsmith needs clarification

### 3. Dynamic Context Adaptation

Beadsmith adapts context dynamically throughout your conversation. It considers the complexity of your request, available context window space, current task progress, error messages and feedback, plus previous decisions made during the conversation to determine what information matters most at each step.
...
<Frame caption="The context window bar shows input/output token usage">
	<img
		src="https://storage.googleapis.com/beadsmith_public_images/context-bar.png"
...
Beadsmith includes intelligent systems that handle context for you:

### Focus Chain (Default: ON)

Focus Chain maintains task continuity through automatic todo lists. When you start a task, Beadsmith generates actionable steps and updates them as work progresses. This keeps critical context visible even after Auto Compact runs, letting you track progress without scrolling through the entire conversation.
...
If your conversation approaches the model's context window limit before Auto Compact runs, Beadsmith's Context Manager automatically truncates older parts of the conversation to prevent errors.
...
This happens automatically. You'll keep working without interruption, and Beadsmith maintains enough context to continue solving your problem effectively.

## Best Practices

- **Be specific** - Clear objectives help Beadsmith understand your needs
...
<CardGroup cols={2}>
	...
	<Card title="Memory Bank" icon="brain" href="/prompting/beadsmith-memory-bank">
		Set up persistent project knowledge
	</Card>
	<Card title="Beadsmith Rules" icon="gavel" href="/features/beadsmith-rules">
