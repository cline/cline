...
|-------|---------------|-----------------|----------|
| **Claude Sonnet 4.5** | 1,000,000 tokens | 500,000 tokens | Complex tasks, large codebases |
| **GPT-5** | 400,000 tokens | 300,000 tokens | General purpose development |
| **Gemini 2.5 Pro** | 1,000,000+ tokens | 600,000 tokens | Very large contexts |
| **DeepSeek V3** | 128,000 tokens | 100,000 tokens | Cost-effective coding |
| **Qwen3 Coder** | 256,000 tokens | 200,000 tokens | Specialized coding tasks |
...
<CardGroup cols={2}>
	...
	<Card title="Cline Rules" icon="gavel" href="/customization/cline-rules">
