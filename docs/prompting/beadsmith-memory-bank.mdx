---
title: "Beadsmith Memory Bank"
---

## The Complete Guide to Beadsmith Memory Bank

### Quick Setup Guide

To get started with Beadsmith Memory Bank:

1. **Copy the Custom Instructions** - Use the code block below
2. **Paste into Beadsmith** - Add as custom instructions or in a .beadsmithrules file
3. **Initialize** - Ask Beadsmith to "initialize memory bank"

[See detailed setup instructions](#getting-started-with-memory-bank)

### Beadsmith Memory Bank Custom Instructions \[COPY THIS]

```
# Beadsmith's Memory Bank

I am Beadsmith, an expert software engineer with a unique characteristic: my memory resets completely between sessions. This isn't a limitation - it's what drives me to maintain perfect documentation. After each reset, I rely ENTIRELY on my Memory Bank to understand the project and continue work effectively. I MUST read ALL memory bank files at the start of EVERY task - this is not optional.
...
### What is the Beadsmith Memory Bank?

The Memory Bank is a structured documentation system that allows Beadsmith to maintain context across sessions. It transforms Beadsmith from a stateless assistant into a persistent development partner that can effectively "remember" your project details over time.

#### Key Benefits

-   **Context Preservation**: Maintain project knowledge across sessions
-   **Consistent Development**: Experience predictable interactions with Beadsmith
...
The Memory Bank isn't a Beadsmith-specific feature - it's a methodology for managing AI context through structured documentation. When you instruct Beadsmith to "follow custom instructions," it reads the Memory Bank files to rebuild its understanding of your project.

<Frame>
	<img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(15).png" alt="Memory Bank Workflow" />
</Frame>

#### Understanding the Files

Memory Bank files are simply markdown files you create in your project. They're not hidden or special files - just regular documentation stored in your repository that both you and Beadsmith can access.

Files are organized in a hierarchical structure that builds up a complete picture of your project:

<Frame>
	<img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(16).png" alt="Memory Bank File Structure" />
</Frame>
...
3. Ask Beadsmith to "initialize memory bank"

<Frame>
	<img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(17).png" alt="Memory Bank Setup" />
</Frame>
...
-   Beadsmith will help fill in gaps and ask questions
-   You can update it as your project evolves

### Working with Beadsmith
...
-   **"follow your custom instructions"** - This tells Beadsmith to read the Memory Bank files and continue where you left off (use this at the start of tasks)
...
#### Should I use custom instructions or .beadsmithrules?

Either approach works - it's based on your preference:

-   **Custom Instructions**: Applied globally to all Beadsmith conversations. Good for consistent behavior across all projects.
-   **.beadsmithrules file**: Project-specific and stored in your repository. Good for per-project customization.
...
As you work with Beadsmith, your context window will eventually fill up (note the progress bar). When you notice Beadsmith's responses slowing down or references to earlier parts of the conversation becoming less accurate, it's time to:

1. Ask Beadsmith to **"update memory bank"** to document the current state
2. Start a new conversation/task
3. Ask Beadsmith to **"follow your custom instructions"** in the new conversation
...
<Frame>
	<img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(18).png" alt="Memory Bank Context Window" />
</Frame>

#### How often should I update the memory bank?

Update the Memory Bank after significant milestones or changes in direction. For active development, updates every few sessions can be helpful. Use the **"update memory bank"** command when you want to ensure all context is preserved. However, you will notice Beadsmith automatically updating the Memory Bank as well.

#### Does this work with other AI tools beyond Beadsmith?
...
-   Let Beadsmith help create the initial structure
...
1. Open VSCode
2. Click the Beadsmith extension settings ⚙️
3. Find "Custom Instructions"
4. Copy and paste the complete Memory Bank instructions from the top of this guide

#### For .beadsmithrules (Project-Specific)

1. Create a `.beadsmithrules` file in your project root
2. Copy and paste the Memory Bank instructions from the top of this guide
3. Save the file
4. Beadsmith will automatically apply these rules when working in this project

### Remember

The Memory Bank is Beadsmith's only link to previous work. Its effectiveness depends entirely on maintaining clear, accurate documentation and confirming context preservation in every interaction.

_For more information, reference our_ [_blog_](https://beadsmith.bot/blog/memory-bank-how-to-make-beadsmith-an-ai-agent-that-never-forgets) _on Beadsmith Memory Bank_

---

### Contributing to Beadsmith Memory Bank

This guide is maintained by the Beadsmith and the Beadsmith Discord Community:
