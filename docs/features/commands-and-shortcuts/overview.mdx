...
-   In the editor context menu (right-click menu)
-   In the terminal context menu
-   In the Source Control view
-   As keyboard shortcuts
-   As Quick Fix options (lightbulb menu)
...
<Columns cols={2}>
  <Card title="Code Commands" icon="code" href="/features/commands-and-shortcuts/code-commands">
    Right-click on code to add it to Cline, fix errors, or generate documentation. Cline sees the complete code context, including imports and surrounding functions.
  </Card>
...
<Card title="Keyboard Shortcuts" icon="keyboard" href="/features/commands-and-shortcuts/keyboard-shortcuts">
	Speed up your workflow with keyboard shortcuts for common Cline actions. Quickly add code to chat, fix errors, or generate documentation.
</Card>
</Columns>
