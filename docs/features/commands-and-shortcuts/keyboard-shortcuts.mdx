...
<Info>
**Pro Tip:** Assign a keyboard shortcut to `cline.addTerminalOutputToChat` (like `Alt+T`) so you can quickly capture terminal output without right-clicking. This is especially useful when debugging errors or analyzing command output.
</Info>
