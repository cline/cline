...
#### Add selected to Cline

The "Add selected to Cline" command sends your selected code to the Cline chat panel. This is perfect for:
...
3. Choose "Add selected to Cline"
...
3. **Command Processing**:
    ...
    - For "Add selected to Cline," the code is formatted and sent to the chat panel
