...
description: "Learn what tasks are in Beadsmith, how they work, and how to create effective prompts for better results."
---

## What are Tasks?

Most users interact with Beadsmith through **tasks** - the fundamental unit of work that drives every coding session. Whether you're building a new feature, fixing a bug, refactoring code, or exploring a codebase, every interaction with Beadsmith happens within the context of a task. A task represents a complete conversation and work session between you and the AI agent, created through **prompts** - the instructions you provide to tell Beadsmith what you want to accomplish. Tasks serve as self-contained work sessions that capture your entire conversation with Beadsmith, including all the code changes, command executions, and decisions made along the way.

This approach ensures that your work is organized, traceable, and resumable. Each task maintains its own isolated context, allowing you to work on multiple projects simultaneously without confusion. The beauty of Beadsmith's task system lies in its flexibility and persistence, providing a collaborative coding session where you provide the direction through prompts, and Beadsmith executes your vision with precision.

### Key Characteristics

Each task in Beadsmith:
...
These features make Beadsmith not just a coding tool, but a comprehensive development agent that understands the full lifecycle of your work.

## Creating Tasks with Prompts

Tasks begin with prompts - your instructions to Beadsmith. The quality of your results depends heavily on how you describe what you want.
...
Deep dive into **Module 1: "Prompting"** in [Beadsmith Learn](https://beadsmithlearn.com) to become an expert at creating effective prompts. The module covers:
...
Beadsmith operates in two distinct modes that help structure your workflow:

- **Plan Mode**: For information gathering, discussing approaches, and creating strategies without making changes
- **Act Mode**: For actual implementation where Beadsmith executes file modifications, runs commands, and uses tools
...
One of Beadsmith's powerful features is the ability to resume interrupted tasks:
...
2. Beadsmith loads the complete conversation
...
This context allows Beadsmith to:
- Understand what has been done
- Maintain consistency in approach
- Resume work intelligently
- Learn from previous attempts

→ **[Learn more about Context Management](/getting-started/understanding-context-management)** to understand how Beadsmith manages and optimizes context across tasks.

Understanding how tasks work is fundamental to using Beadsmith effectively. With well-crafted prompts and an understanding of the task lifecycle, you can leverage Beadsmith's full potential to accelerate your development workflow.
