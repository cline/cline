...
<Note>
**Cline Account Required:** Dictation uses Cline's cloud transcription service at $0.0065 credits per minute (5 minutes max per message). You must be signed into your Cline account to use this feature.
</Note>
