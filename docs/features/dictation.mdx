---
title: "Dictation"
description: "Communicate with Beadsmith using your voice for faster, more natural AI collaboration"
---
...
Use Dictation constantly in [Plan mode](/features/plan-and-act) for rapid back-and-forth discussions. Instead of typing careful, structured prompts, think about a problem. Beadsmith asks clarifying questions, respond immediately, and iterate until having a solid plan.
...
3. Sign into your Beadsmith account when prompted
4. Install FFmpeg if you haven't already (Beadsmith will guide you)
...
<Tip>
Dictation works with any AI model you've configured. The transcription happens through Beadsmith's service, but your conversation continues with whatever model you're using.
</Tip>
...
If you don't have FFmpeg installed, Beadsmith will automatically detect this and prompt you to install it with a single click.
...
- Respond to Beadsmith's questions immediately
- Iterate on ideas without typing friction
- Think out loud while Beadsmith listens
...
- Beadsmith account with transcription credits
...
Voice transcription costs $0.006 per minute through your Beadsmith account. For most users, this works out to pennies per session.
...
- Check if firewall is blocking Beadsmith's servers
- Try signing out and back into your Beadsmith account

**Authentication Issues**
- Sign out and back into your Beadsmith account if you see authentication errors
