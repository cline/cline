...
<Note>
**Token Savings:** In large monorepos, `.clinecontext` can reduce context tokens by 60-70% by excluding unnecessary files and sections from the environment details sent to the AI model.
</Note>
