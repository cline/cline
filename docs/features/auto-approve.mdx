...
- **Notifications**: The notification toggle is located at the bottom of the Auto Approve menu. If enabled, Cline sends OS-level notifications when approval is required, and when an auto-approved terminal command has been running for 30 seconds and may need attention.
...
| Enable notifications | Notifies you about long-running auto-approved commands | Found at the bottom of the Auto Approve menu |
...
The "Enable notifications" toggle is located at the bottom of the Auto Approve menu, below a separator line. This makes it easy to toggle notifications on or off while configuring your auto-approve settings.
