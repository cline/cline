...
<Frame>
	<img
		src="https://storage.googleapis.com/cline_public_images/docs/assets/auto-approve.png"
		alt="Auto Approve settings menu"
	/>
</Frame>

## How it works

Auto Approve is evaluated per tool call. When Cline is about to read a file, edit a file, run a command, or use the browser, he checks your Auto Approve settings for that category.
...
| Use the browser | Browser tool, plus web fetch and web search | Proxy issues can apply |
