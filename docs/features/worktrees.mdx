...
<Steps>
  <Step title="Open the Worktrees View">
    Click the **Worktrees** button in the Cline sidebar header to open the Worktrees view.
  </Step>
  <Step title="Create a New Worktree">
    Click **New Worktree** at the bottom of the view. You'll need to provide:
    - **Branch name**: The new branch to create (e.g., `feature/user-auth`)
    - **Path**: Where to create the worktree folder
    
    <Tip>
      Click **Auto-fill with suggested values** to get a random branch name and a path in your Documents folder.
    </Tip>
  </Step>
  <Step title="Open in New Window">
    Once created, click the **Open in new window** button to open the worktree in a separate VS Code window. Now you can run Cline independently in that window!
  </Step>
</Steps>
...
Click the trash icon on any linked worktree to delete it. This removes the worktree folder and unlinks it from your repository. The branch itself is preserved—only the working directory is removed.
...
## Worktreeinclude: Automatic File Copying {#worktreeinclude}
