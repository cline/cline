...
<Frame>
	<img
		src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/newtask.png"
		alt="Using the /newtask slash command"
	/>
</Frame>

-   Type `/newtask` in the chat input field
-   Beadsmith will analyze your conversation and propose a distilled version of the context to carry forward
...
Rather than losing those insights or starting from scratch, I use `/newtask` to have Beadsmith extract what matters - the key decisions, file changes, and progress so far - without all the noise of individual tool calls and research steps.
