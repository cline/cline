...
<Frame>
	<img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/smol.png" alt="Using the /smol slash command" />
</Frame>

-   Type `/smol` (or its alias `/compact`) in the chat input field
-   Beadsmith will analyze your conversation and create a detailed summary that preserves essential information
