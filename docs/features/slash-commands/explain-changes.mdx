...
<Frame>
	<img
		src="https://storage.googleapis.com/cline_public_images/docs/assets/explain-changes-command.png"
		alt="Using the /explain-changes slash command"
	/>
</Frame>
...
For PR explanations, you'll need the [GitHub CLI (gh)](https://cli.github.com/) installed and authenticated.
