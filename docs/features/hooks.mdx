...
Cline provides eight hook types that let you tap into different stages of the AI workflow. They're organized into four categories based on their trigger points and use cases.
