...
Voice Mode transforms how you work with AI. Instead of typing out complex thoughts, you speak naturally and share your complete intent. This isn't just about speed - though voice is faster - it's about unlocking the kind of fluid collaboration that typing can't match.
...
Use Voice Mode constantly in [Plan mode](/features/plan-and-act) for rapid back-and-forth discussions. Instead of typing careful, structured prompts, think about a problem. Cline asks clarifying questions, respond immediately, and iterate until having a solid plan.
...
- Speak naturally - the button turns red while recording
- Click again to stop recording
- Wait for transcription to appear in the chat

<Tip>
Voice Mode works with any AI model you've configured. The transcription happens through Cline's service, but your conversation continues with whatever model you're using.
</Tip>

## System Requirements

Voice Mode uses FFmpeg to capture your voice across all platforms:
...
## Where Voice Mode Shines

### Plan Mode Conversations

Voice Mode is perfect for [Plan mode](/features/plan-and-act) discussions. Instead of carefully crafting prompts, you can:
...
Voice Mode is perfect for exploratory conversations where you're not sure exactly what you need. Start talking through the problem and let the conversation evolve.
