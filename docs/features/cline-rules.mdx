...
Cline also supports the [Agent Rules](https://agent-rules.org/) community standard as a 
fallback (in addition to Cline Rules) by automatically detecting `AGENTS.md` files in 
