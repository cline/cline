...
Cline's system prompt can now be customized through the [Custom Prompts System](/CUSTOM_PROMPTS_IMPLEMENTATION.md), which allows you to create personalized prompts while automatically merging with Cline's essential capabilities. For a broader look at prompt engineering best practices, check out [this resource](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview).
...
your workspace root. This way you can use the same rules file across different AI 
coding tools.
