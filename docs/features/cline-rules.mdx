...
Once you save the file, it will be stored in the `.clinerules/` directory in your project (if it's a workspace rule) or in the Documents/Cline/Rules directory (if it's a global rule).
