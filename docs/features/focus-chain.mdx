...
description: "A compatibility todo-tracking feature for users who still want a persistent checklist alongside built-in task_progress checklists and Plan & Act workflows."
---

Focus Chain is a compatibility todo-tracking feature that maintains a visible checklist across long-running tasks. It is still available in this branch, but it is no longer the primary product direction for task planning and progress tracking.
