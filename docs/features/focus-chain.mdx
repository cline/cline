...
Focus Chain is a task management enhancement feature in Beadsmith that provides automatic todo list management with real-time progress tracking throughout your tasks. 

<Frame>
	<img
		src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/2dos.gif"
		alt="Focus Chain todo list management with real-time progress tracking"
	/>
</Frame>

This enables Beadsmith to work on long-horizon tasks, seamlessly managing the context sent to LLMs, and keeping Beadsmith on track across many context window resets.

<Tip>
  Focus Chain works particularly well with Beadsmith's [Deep Planning slash command](/features/slash-commands/deep-planning), providing seamless progress tracking for implementation tasks created through the [planning process](/features/plan-and-act).
</Tip>
...
Beadsmith analyzes your task and automatically creates a comprehensive todo list with:
...
- Seamless integration back into Beadsmith's workflow
...
<Steps>
  <Step title="Open Beadsmith Settings">
      - Click the gear icon in the Beadsmith sidebar
      - Navigate to the "Features" section
  </Step>
  <Step title="Enable Focus Chain">
      - Check "Enable Focus Chain"
      - Optionally adjust "Remind Beadsmith Interval" (default: 6 messages)
  </Step>
  <Step title="Start a New Task">
      - Begin a new task
      - Beadsmith will automatically start creating and managing todo lists
  </Step>
</Steps>
...
| Remind Beadsmith Interval | 6 | 1-100 messages | How often Beadsmith updates the todo list |
...
Beadsmith: [Analyzes request and creates todo list]
```

#### 2. Todo List Created

Beadsmith creates a comprehensive plan for the task, stored in a markdown file:
...
As Beadsmith works, the task header shows real-time progress:
...
<Steps>
  ...
  <Step title="Save the file">
    Beadsmith automatically detects and uses your updates
  </Step>
</Steps>
...
Focus Chain works seamlessly with Beadsmith's [Plan/Act mode](/features/plan-and-act):
...
<AccordionGroup>
  <Accordion title="For Effective Todo Lists">
    ...
    2. **Review Generated Lists**
      - Check that Beadsmith's breakdown aligns with your expectations
  ...
  <Accordion title="For Complex Projects">
    ...
    3. **Regular Reviews**
      ...
      - Communicate changes to Beadsmith through edits
  </Accordion>
...
Still stuck? Use the [/reportbug](/features/slash-commands/report-bug) command in Beadsmith to get help.
...
Focus Chain turns Beadsmith into your personal project manager, keeping you on track and your tasks organized. Give it a try on your next project!
