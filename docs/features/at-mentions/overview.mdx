...
<Card title="Problems Mention" icon="triangle-exclamation" href="/features/at-mentions/problem-mentions">
...
<Card title="Terminal Mention" icon="terminal" href="/features/at-mentions/terminal-mentions">
