...
If you're experiencing issues with terminal mentions or terminal integration in general (such as "Shell Integration Unavailable" or commands not showing output), please refer to our [Terminal Quick Fixes](/troubleshooting/terminal-quick-fixes) guide.
