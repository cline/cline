...
<Steps>
  ...
  <Step title="Open Agent Panel">
    Click the Cursor cube icon button (AI Panel) that opens Cursor's agent (right side view panel)
  </Step>
  <Step title="Drag to AI Panel Sidebar">
    Drag the Cline icon directly into the AI Panel sidebar.
  </Step>
</Steps>
