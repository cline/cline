...
Plan & Act modes represent Beadsmith's approach to structured AI development, emphasizing thoughtful planning before implementation. This dual-mode system helps developers create more maintainable, accurate code while reducing iteration time.
...
Plan mode is where you and Beadsmith figure out what you're trying to build and how you'll build it. In this mode, Beadsmith:
...
Once you've got a plan, you switch to Act mode. Now Beadsmith:
...
<Frame>
	<img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(5).png" alt="Act mode capabilities" />
</Frame>
...
1. I start in Plan mode and tell Beadsmith what I want to build
2. Beadsmith helps me explore the codebase, looking at relevant files
...
5. Beadsmith implements the solution based on our planning
...
<Frame>
	<img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(5)%20(1).png" alt="Plan mode workflow" />
</Frame>

-   Share your requirements
-   Let Beadsmith analyze relevant files
-   Engage in dialogue to clarify objectives
-   Develop implementation strategy

<Frame>
	<img
		src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(2)%20(1)%20(1)%20(1).png"
		alt="Planning phase"
	/>
</Frame>
...
<Frame>
	<img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/switching-to-act.gif" alt="Switching to Act mode" />
</Frame>

Act mode allows Beadsmith to:
...
3. Point Beadsmith to relevant files if he hasn't read them
...
<Frame>
	<img
		src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(3)%20(1).png"
...
-   Have Beadsmith write markdown files of the plan for future reference
...
<Frame>
	<img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(6).png" alt="Mode usage patterns" />
</Frame>
...
-   Join our [Discord community](https://discord.gg/beadsmith)
