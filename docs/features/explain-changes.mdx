...
<Frame>
	<img
		src="https://storage.googleapis.com/cline_public_images/docs/assets/explain-changes-button.png"
		alt="Explain Changes button in completion message"
	/>
</Frame>
...
<Note>
Explain Changes requires **Checkpoints** to be enabled. Checkpoints track the state of your workspace at each step, which is necessary for generating accurate diffs.
</Note>

To enable checkpoints:
1. Open VS Code settings
2. Search for "Cline checkpoints"
3. Enable the checkpoint feature

See [Checkpoints](/features/checkpoints) for more information.
