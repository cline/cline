...
<Tip>
Auto Compact works well with Cline's built-in task-progress tracking and, if you still use it, [Focus Chain](/features/focus-chain). When Focus Chain is enabled, todo lists persist across summarizations.
</Tip>
