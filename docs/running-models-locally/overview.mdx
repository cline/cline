...
<Tabs>
  ...
  <Tab title="QVAC">
    [QVAC](https://qvac.com) is an open-source runtime for local-first, peer-to-peer AI. It exposes an OpenAI-compatible HTTP server, so you connect to it through Cline's **OpenAI Compatible** provider.
