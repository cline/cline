...
- Disable aggressive terminal reuse in Cline Settings → Terminal if commands appear to reuse stale shell state
- Keep your shell startup files lightweight so local-model commands start quickly and predictably
