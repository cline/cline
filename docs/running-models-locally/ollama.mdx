...
For the best experience with Cline, use models with strong coding capabilities. Here are some currently available options:

**For coding tasks:**
- `qwen2.5-coder:32b` - Excellent coding performance with 32K context
- `deepseek-coder:6.7b` - Lightweight code-specialized model
- `codellama:13b-code` - Good balance of performance and size

**For general tasks:**
- `llama3.1:8b` - Well-rounded general purpose model
- `mistral:7b` - Good performance and speed
- `qwen2.5:7b` - Strong general capabilities
