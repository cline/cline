...
- [x] Long task histories with large per-message text bodies
...
- [x] Use summary output instead of full original-file echoes in edit failure messages for large files, including replace-in-file diff failures.
...
- [x] create task -> open diff -> cancel before completion, repeated N times
...
- [x] noisy MCP notification run
- [x] large-file edit run under reduced heap
