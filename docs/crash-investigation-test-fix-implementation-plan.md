...
- [ ] Avoid returning full final file content for oversized files.
- [ ] Use summary output instead of full content in approval messages for large files.
...
- [ ] cancellation/restart churn tests
