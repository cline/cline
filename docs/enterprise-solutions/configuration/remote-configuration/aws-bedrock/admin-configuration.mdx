...
This guide is for the web-based admin console at [app.cline.bot](https://app.cline.bot). For self-hosted infrastructure setup with multi-account AWS, VPC endpoints, CloudTrail logging, and advanced features, see [AWS Bedrock Self-Hosted Configuration](/enterprise-solutions/configuration/infrastructure-configuration/providers/aws-bedrock/overview).
</Info>
