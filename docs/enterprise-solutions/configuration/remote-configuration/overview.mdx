...
<CardGroup cols={3}>
  ...
  <Card title="Anthropic" icon="message-bot" href="/enterprise-solutions/configuration/remote-configuration/anthropic/admin-configuration">
    Direct Anthropic API access with optional custom base URL.
  </Card>
