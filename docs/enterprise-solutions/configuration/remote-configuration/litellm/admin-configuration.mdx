...
<Note>
If you haven't deployed LiteLLM yet, check the [Enterprise Infrastructure Setup](/enterprise-solutions/configuration/infrastructure-configuration/providers/litellm/overview) for deployment guidance, or work with your infrastructure team to set up a LiteLLM proxy instance.
</Note>
