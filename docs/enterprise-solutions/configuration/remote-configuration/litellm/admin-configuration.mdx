...
description: "This guide explains how administrators configure LiteLLM as the organization-wide LLM provider for Beadsmith."
---


As an administrator, you can add LiteLLM as the organization-wide LLM provider for all Beadsmith users through the hosted admin console. This centralized approach provides unified access to multiple AI models through your LiteLLM proxy interface.

## Before You Begin

To get started with setting up LiteLLM as your organization's LLM provider, you'll need a few items in place.

**Administrator access to the Beadsmith Admin console**  
You need admin privileges to enforce provider settings across your organization. If you can navigate to **Settings → Beadsmith Settings** in the admin console at [app.beadsmith.bot](https://app.beadsmith.bot), you have the right access level.
...
<Steps>
<Step title="Access Beadsmith Settings">
Navigate to [app.beadsmith.bot](https://app.beadsmith.bot) and sign in with your administrator account. Go to **Settings → Beadsmith Settings**.
...
Once saved, all organization members signed into the Beadsmith extension will automatically use LiteLLM with your configured settings. They won't be able to select other providers or switch to their personal Beadsmith accounts.

<Warning>
Members can't switch to personal Beadsmith accounts or join other organizations once remote configuration is enabled. This ensures consistent provider usage across your team.
</Warning>
</Step>
</Steps>
