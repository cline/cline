...
<Tip>
API keys are stored locally in VS Code and are only used by the Beadsmith extension.
</Tip>
</Accordion>
...
Send a test message in Beadsmith to verify your connection works correctly with the LiteLLM proxy.
...
Confirm you're signed into the correct Beadsmith organization. Verify your administrator has saved the LiteLLM configuration and that you have the latest version of the Beadsmith extension.
...
- Regularly update the Beadsmith extension for security patches
