...
4. Beadsmith will use your default Google Cloud credentials automatically
</Accordion>
...
4. Beadsmith will automatically detect credentials from your environment
</Accordion>
</AccordionGroup>
...
Send a test message in Beadsmith to verify your credentials work correctly with the configured Vertex AI project and region.
...
- **Image Analysis**: Upload images directly in Beadsmith for analysis
...
Confirm you're signed into the correct Beadsmith organization. Verify your administrator has saved the Vertex AI configuration and that you have the latest version of the Beadsmith extension.
