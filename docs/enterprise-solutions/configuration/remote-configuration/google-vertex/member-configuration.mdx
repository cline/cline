...
<Note>
If you don't have Google Cloud access yet, reach out to your IT or cloud team to get service account keys or Google Cloud SDK configured with the necessary Vertex AI permissions.
</Note>

<Frame>
	<img
		src="https://storage.googleapis.com/cline-static-assets-prod/assets/VS%20Code%20Vertex%20API%20Key.gif"
	/>
</Frame>
