...
description: "Deploy and configure Beadsmith on your own infrastructure with enterprise-grade security and compliance"
---

<Warning>
**Self-Hosted Configuration Path**

This section is for enterprises deploying **self-hosted Beadsmith infrastructure** with complex security, compliance, and multi-environment requirements. Configuration is done through YAML files, Kubernetes/Helm deployments, and infrastructure-as-code.

**Looking for simple setup?** See [SaaS Provider Configuration](/enterprise-solutions/configuration/remote-configuration/overview) for quick configuration through the app.beadsmith.bot admin console - no infrastructure deployment required, just web-based settings.
</Warning>

Self-Hosted Configuration provides centralized control over all aspects of your Beadsmith deployment on your own infrastructure, from AI providers to custom workflows. This section covers how to configure, manage, and optimize your enterprise Beadsmith installation with advanced security, compliance, and operational features.
...
<CardGroup cols={2}>
  <Card title="Control Other Beadsmith Features" icon="toggles" href="/enterprise-solutions/configuration/infrastructure-configuration/control-other-beadsmith-features/overview">
    Enable or disable specific Beadsmith features across your organization with granular permission controls.
  </Card>
...
For hands-on configuration assistance, contact your Beadsmith Enterprise support team or refer to our implementation guides.
