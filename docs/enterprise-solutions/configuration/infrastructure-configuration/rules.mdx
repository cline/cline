...
|----------------|------|----------|
| `.cursorrules` | Cursor | Workspace root |
| `.cursor/rules/` | Cursor | Workspace directory |
| `.windsurfrules` | Windsurf | Workspace root |
| `AGENTS.md` | Various | Any directory (recursive) |
