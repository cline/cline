...
For enterprise deployments, Cline supports OpenTelemetry for advanced monitoring:

- Export telemetry to your own systems
- Aggregate data across your organization
- Custom dashboards and alerting
- Integration with existing observability tools

See [OpenTelemetry](/enterprise-solutions/monitoring/opentelemetry) for configuration details.
