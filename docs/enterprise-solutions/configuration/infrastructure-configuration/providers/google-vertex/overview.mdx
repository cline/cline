...
description: "Configure Google Vertex AI for your Beadsmith deployment"
---
...
Configure Beadsmith to use Google Vertex AI for enterprise access to Gemini and other Google AI models through Google Cloud Platform.
...
Before configuring Beadsmith to use Vertex AI, you need:
