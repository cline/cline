...
description: "Configure custom OpenAI-compatible providers for your Beadsmith deployment"
---
...
Configure Beadsmith to use any OpenAI-compatible API provider, including Azure OpenAI, self-hosted inference servers, and other third-party services.
...
4. **Network Access**: Connectivity from where Beadsmith is being used
