...
description: "Configure AWS Bedrock for your Beadsmith deployment"
---
...
Configure Beadsmith to use AWS Bedrock for enterprise access to Claude and other foundation models through Amazon's managed service.
...
Before configuring Beadsmith to use Bedrock, you need:
