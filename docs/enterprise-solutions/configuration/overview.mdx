...
description: "Understanding enterprise configuration options for AI providers and system settings"
---

Cline offers two distinct approaches to configure AI providers and system settings for your organization. Understanding the difference between these approaches will help you choose the right configuration method for your needs.
...
<CardGroup cols={2}>
  <Card title="Remote Configuration" icon="cloud" href="/enterprise-solutions/configuration/remote-configuration/overview">
    **Simple cloud-based setup**
    ...
    Configure AI providers through the Cline admin console at app.cline.bot. Ideal for quick organizational deployment with minimal infrastructure requirements.
  </Card>
  
  <Card title="Infrastructure Configuration" icon="server" href="/enterprise-solutions/configuration/infrastructure-configuration/overview">
    **Advanced enterprise setup**
    
    Deep infrastructure integration with VPC endpoints, multi-account support, compliance features, and custom workflows.
  </Card>
</CardGroup>

## Choosing the Right Configuration

### Use Remote Configuration When:
...
### Use Infrastructure Configuration When:
...
| Feature | Remote Configuration | Infrastructure Configuration |
|---------|---------------------|------------------------------|
...
Select either Remote Configuration for simple setup or Infrastructure Configuration for advanced enterprise features.
</Step>
...
Both configuration approaches support the same core AI providers:
