...
Beadsmith offers two distinct approaches to configure inference providers and system settings for your organization. Understanding the difference between these approaches will help you choose the right configuration method for your needs.
...
<CardGroup cols={2}>
  <Card title="SaaS Provider Configuration" icon="cloud" href="/enterprise-solutions/configuration/remote-configuration/overview">
    **Simple cloud-based setup**
    ...
    Configure inference providers through the Beadsmith [admin console](https://app.beadsmith.bot/dashboard). Ideal for quick organizational deployment with minimal infrastructure requirements.
  </Card>
