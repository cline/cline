...
description: "Decide between SaaS and Self-Hosted configuration for your Beadsmith Enterprise deployment"
---
...
| **GitOps** | ❌ | ✅ |
| **Maintenance** | Managed by Beadsmith | Self-managed |
...
| **Data Residency** | Beadsmith-managed deployment | Customer-controlled deployment |

### Cost Structure

| Cost Category | SaaS | Self-Hosted |
|---------------|------|-------------|
| **Beadsmith Subscription** | Fixed enterprise fee | Fixed enterprise fee |
...
- [**Contact Beadsmith Enterprise Sales**](https://beadsmith.bot/contact-sales) for a consultation on your specific requirements
