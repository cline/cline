...
description: "Complete guide to managing team members, roles, and permissions in your Beadsmith Enterprise organization"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Member" icon="user" color="#560BAD">
    **Developers & contributors**
    ...
    Can use Beadsmith with shared resources but cannot change settings. The safest default for most team members.
  </Card>
</CardGroup>
...
<Tabs>
  <Tab title="Adding Members">
    ...
    1. **Navigate to Members**
       - Go to your organization dashboard at app.beadsmith.bot
    ...
    <Tip>
    **Bulk Invitations:** Need to add multiple users? Contact support@beadsmith.bot for assistance with bulk invite CSV imports.
    </Tip>
  </Tab>
...
<Note>
These requirements ensure that only authenticated users from your company can access your Beadsmith organization, preventing unauthorized access.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Upgrading Your License" icon="arrow-up">
    Need more seats?
    - **Teams Plan:** Contact your account manager or visit app.beadsmith.bot/settings/billing to upgrade your license.
...
<CardGroup cols={2}>
  ...
  <Card title="Offboarding Process" icon="door-open">
    Create a standard offboarding checklist: remove from Beadsmith, revoke IDP access, document in audit log, and reassign any critical responsibilities.
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Can't Remove an Admin" icon="user-slash">
    ...
    **Solution:** Ask an Owner to perform the removal, or if you need to remove your organization's sole Owner, contact support@beadsmith.bot.
  </Accordion>
...
<Tip>
**Getting Started Fast?** The quickest path is: 1) Invite your team as Members, 2) Configure one API provider, 3) Let your team start using Beadsmith. You can refine roles and settings later.
</Tip>
