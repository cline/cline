...
<Steps>
  ...
  <Step title="Domain Verification">
    Your organization must have a **verified domain** with a supported provider:
...
<AccordionGroup>
  ...
  <Accordion title="Upgrading Your License" icon="arrow-up">
    Need more seats? Contact your account manager or visit app.cline.bot/settings/billing to upgrade your license.
  </Accordion>
</AccordionGroup>
