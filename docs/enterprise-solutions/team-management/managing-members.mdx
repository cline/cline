...
This guide covers the practical steps for adding, editing, and removing members from your enterprise dashboard. For a conceptual overview of roles and permissions, see the [Roles and Permissions](/enterprise-solutions/team-management/roles-and-permissions).
...
Refer to the [Roles and Permissions](/enterprise-solutions/team-management/roles-and-permissions) for a detailed breakdown of what each role can do.
