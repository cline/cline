...
Now that you understand the different roles and how to manage them, you can proceed to [configuring provider remote access](/enterprise-solutions/configuration/remote-configuration/aws-bedrock/admin-configuration) for your organization.
