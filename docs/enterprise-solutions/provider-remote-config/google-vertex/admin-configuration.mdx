...
As an administrator, you can add Google Vertex AI as the organization-wide LLM provider for all Cline users. This centralized approach ensures consistent access to Google's advanced AI models while maintaining your organization's project boundaries, regional compliance requirements, and cost controls through Google Cloud's enterprise billing.
...
<Note>
If you haven't set up Google Cloud or Vertex AI yet, check the [Enterprise Infrastructure Setup](/enterprise-solutions/enterprise-configurations/providers/google-vertex/overview) for comprehensive deployment guidance.
</Note>
...
[View Google Cloud Regions](https://cloud.google.com/compute/docs/regions-zones)
...
- **PaLM models**: Text generation and reasoning
- **Codey models**: Code generation and completion
- **Custom models**: Your organization's fine-tuned models
</Accordion>

<Accordion title="Authentication Method (optional)">
Configure how team members will authenticate with Vertex AI:
- **Service Account Keys**: Centralized key management  
- **Application Default Credentials**: Use local Google Cloud authentication
- **Workload Identity**: For containerized environments
</Accordion>
...
**PaLM Models:**
- **PaLM 2**: Text generation and conversational AI
- **Chat-Bison**: Optimized for conversational interfaces
- **Text-Bison**: Focused on text completion and generation
