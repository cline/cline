...
<CardGroup cols={2}>
  <Card title="MCP Marketplace" icon="store" href="/enterprise-solutions/enterprise-configurations/mcp/mcp-marketplace">
    Pre-built, enterprise-ready MCP servers for popular tools and services with one-click deployment.
  </Card>
  
  <Card title="Remote MCP Servers" icon="server" href="/enterprise-solutions/enterprise-configurations/mcp/remote-mcp-servers">
...
1. [MCP Marketplace](/enterprise-solutions/enterprise-configurations/mcp/mcp-marketplace) - Deploy pre-built integrations
2. [Remote MCP Servers](/enterprise-solutions/enterprise-configurations/mcp/remote-mcp-servers) - Configure custom servers
