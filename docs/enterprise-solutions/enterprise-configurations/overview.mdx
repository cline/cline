...
<CardGroup cols={2}>
  <Card title="Providers" icon="cloud" href="/enterprise-solutions/enterprise-configurations/providers/overview">
    Configure AI providers including AWS Bedrock, LiteLLM, and Google Vertex AI with enterprise-grade security and governance.
  </Card>
  
  <Card title="MCP Integration" icon="plug" href="/enterprise-solutions/enterprise-configurations/mcp/overview">
    Manage Model Context Protocol servers, marketplace integrations, and remote MCP server configurations.
  </Card>
  
  <Card title="Rules Engine" icon="shield-check" href="/enterprise-solutions/enterprise-configurations/rules">
    Define and enforce enterprise governance rules, security policies, and compliance requirements.
  </Card>
  
  <Card title="Workflows" icon="workflow" href="/enterprise-solutions/enterprise-configurations/workflows">
...
<CardGroup cols={2}>
  <Card title="Feature Controls" icon="toggles" href="/enterprise-solutions/enterprise-configurations/control-other-cline-features">
...
1. [Provider Configuration](/enterprise-solutions/enterprise-configurations/providers/overview) - Set up your AI providers
2. [Security Rules](/enterprise-solutions/enterprise-configurations/rules) - Implement governance policies  
