...
<CardGroup cols={2}> 
  ...
  <Card title="Advanced OpenTelemetry" icon="chart-line" href="/enterprise-solutions/monitoring/opentelemetry#advanced-configuration">
    Jump straight to custom endpoints, headers, and batching controls
  </Card>
</CardGroup>
