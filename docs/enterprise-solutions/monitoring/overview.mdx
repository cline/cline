...
description: "Optional telemetry and observability for your Beadsmith deployment"
---

Beadsmith includes optional monitoring capabilities for organizations that want to track usage and integrate with their observability infrastructure.
...
<CardGroup cols={1}>
  <Card title="Beadsmith Telemetry" icon="chart-simple" href="/enterprise-solutions/monitoring/telemetry">
    Built-in anonymous usage tracking that helps improve Beadsmith (opt-in)
  </Card>  
</CardGroup>

## Beadsmith Telemetry

Beadsmith includes opt-in telemetry for anonymous usage tracking:
...
Users can enable or disable telemetry in Beadsmith settings. All data is anonymous and does not include code content, file paths, or sensitive information.

See [Beadsmith Telemetry](/enterprise-solutions/monitoring/telemetry) for configuration details.

## OpenTelemetry Integration

For advanced monitoring needs, Beadsmith supports OpenTelemetry's OTLP (OpenTelemetry Protocol) for exporting metrics and logs to your own infrastructure.
...
### When to Use Beadsmith Telemetry
- You want to help improve Beadsmith through anonymous usage data
...
For basic telemetry, enable it in Beadsmith settings. For OpenTelemetry, see the configuration guide.
</Step>
...
All Beadsmith monitoring features are designed with privacy in mind:
