...
<CardGroup cols={2}>
  <Card title="Basic Telemetry" icon="chart-simple">
...
See [Cline Telemetry](/enterprise-solutions/configuration/infrastructure-configuration/control-other-cline-features/telemetry) for configuration details.
...
<CardGroup cols={2}>
  <Card title="Configure Telemetry" icon="gear" href="/enterprise-solutions/configuration/infrastructure-configuration/control-other-cline-features/telemetry">
