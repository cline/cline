---
title: "Beadsmith Telemetry"
sidebarTitle: "Beadsmith Telemetry"
description: "Configure usage analytics and event tracking"
---

Beadsmith includes telemetry to help understand usage patterns and improve the product. Users can control whether to share this data.

## What is Beadsmith Telemetry?
...
### Enabling/Disabling Beadsmith Telemetry

Individual users can control telemetry through Beadsmith settings:

1. Open Beadsmith settings
2. Find "Beadsmith Telemetry" toggle
...
When telemetry is enabled, Beadsmith captures:
...
Beadsmith Telemetry **never** includes:
...
<Note>
Even with enterprise configuration, individual users can still disable Beadsmith Telemetry in their local settings.
</Note>

## Advanced Monitoring

For organizations needing detailed monitoring, Beadsmith supports optional OpenTelemetry integration to export telemetry data to your own observability systems.

See [Enterprise Monitoring](/enterprise-solutions/monitoring/overview) for details on available monitoring options.

## Privacy

Beadsmith's telemetry is designed with privacy in mind:
