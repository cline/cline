...
OpenTelemetry is configured using [Remote Configuration](/enterprise-solutions/configuration/remote-configuration/overview#how-remote-configuration-works) from the [dashboard](https://app.beadsmith.bot/dashboard/organization?tab=settings).
...
<Frame>
	<img
		src="https://assets.int.beadsmith.bot/assets/open_telemetry_main_options.png"
	/>
</Frame>
...
<Frame>
	<img
		src="https://assets.int.beadsmith.bot/assets/open_telemetry_metrics_and_logs.png"
	/>
</Frame>
...
<Frame>
	<img
		src="https://assets.int.beadsmith.bot/assets/open_telemetry_headers.png"
	/>
</Frame>
...
<Frame>
	<img
		src="https://assets.int.beadsmith.bot/assets/open_telemetry_datadog_example.png"
	/>
</Frame>
...
<Frame>
	<img
		src="https://assets.int.beadsmith.bot/assets/open_telemetry_relic_example.png"
	/>
</Frame>
...
<Frame>
	<img
		src="https://assets.int.beadsmith.bot/assets/open_telemetry_grafana_example.png"
	/>
</Frame>
...
Once you’ve done so, if you perform some actions that trigger metrics and/or logs (such as doing a task with Beadsmith), 
