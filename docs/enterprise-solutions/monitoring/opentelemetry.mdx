...
<CardGroup cols={2}>
  <Card title="Basic Telemetry" icon="chart-simple" href="/enterprise-solutions/configuration/infrastructure-configuration/control-other-cline-features/telemetry">
