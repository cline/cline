...
<Tip>
For long-running tasks, enable [Auto-Compact](/customization/auto-compact) to intelligently manage context as you work.
</Tip>
...
For most users, starting with free cloud models and moving to paid options as needed provides the best balance of cost, speed, and capability. Check [Selecting Your Model](/getting-started/selecting-your-model) for guidance on choosing the right option for your workflow.
