...
The `@clinebot/llms` package provides provider registries, model catalogs, handlers, and a gateway. `@clinebot/agents` and `@clinebot/core` use this layer internally.
