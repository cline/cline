...
#### [AWS Bedrock setup for Legacy IAM (AWS Credentials)](/3.17/provider-config/aws-bedrock-with-credentials-authentication)

#### [AWS Bedrock setup for SSO token (AWS Profile)](/3.17/provider-config/aws-bedrock-with-profile-authentication)
