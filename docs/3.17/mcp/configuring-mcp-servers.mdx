...
For more in-depth information about how STDIO transport works, see [MCP Transport Mechanisms](/3.17/mcp/mcp-transport-mechanisms).
...
For more in-depth information about how SSE transport works, see [MCP Transport Mechanisms](/3.17/mcp/mcp-transport-mechanisms).
