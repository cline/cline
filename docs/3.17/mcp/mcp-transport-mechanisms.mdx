...
For detailed information on configuring STDIO and SSE transports in Cline, including examples, see [Configuring MCP Servers](/3.17/mcp/configuring-mcp-servers).
