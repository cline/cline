...
| --------------------------------------------------------------------------------------------- | --------------------------------------------- |
| [`cline.openInNewTab`](/3.17/features/commands-and-shortcuts/overview)                        | Opens Cline in a new editor tab               |
| [`cline.addToChat`](/3.17/features/commands-and-shortcuts/code-commands)                      | Adds selected code to Cline chat              |
| [`cline.addTerminalOutputToChat`](/3.17/features/commands-and-shortcuts/terminal-integration) | Adds terminal output to Cline                 |
| `cline.focusChatInput`                                                                        | Focuses the Cline chat input field            |
| [`cline.generateGitCommitMessage`](/3.17/features/commands-and-shortcuts/git-integration)     | Generates a commit message for staged changes |
| [`cline.explainCode`](/3.17/features/commands-and-shortcuts/code-commands)                    | Explains selected code                        |
| [`cline.improveCode`](/3.17/features/commands-and-shortcuts/code-commands)                    | Suggests improvements for selected code       |
| [`cline.fixWithCline`](/3.17/features/commands-and-shortcuts/code-commands)                   | Fixes code with errors                        |
