...
<Columns cols={2}>
  <Card title="Code Commands" icon="code" href="/3.17/features/commands-and-shortcuts/code-commands">
...
<Card title="Terminal Integration" icon="terminal" href="/3.17/features/commands-and-shortcuts/terminal-integration">
...
<Card title="Git Integration" icon="code-branch" href="/3.17/features/commands-and-shortcuts/git-integration">
...
<Card title="Keyboard Shortcuts" icon="keyboard" href="/3.17/features/commands-and-shortcuts/keyboard-shortcuts">
