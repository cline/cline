...
-   **Use keyboard shortcuts**: Speed up your workflow by [assigning keyboard shortcuts](/3.17/features/commands-and-shortcuts/keyboard-shortcuts) to common code commands
