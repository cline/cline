...
<Columns cols={2}>
  <Card title="File Mentions" icon="file" href="/3.17/features/at-mentions/file-mentions">
...
<Card title="Folder Mentions" icon="folder" href="/3.17/features/at-mentions/folder-mentions">
...
<Card title="Problem Mentions" icon="triangle-exclamation" href="/3.17/features/at-mentions/problem-mentions">
...
<Card title="Terminal Mentions" icon="terminal" href="/3.17/features/at-mentions/terminal-mentions">
...
<Card title="Git Mentions" icon="code-branch" href="/3.17/features/at-mentions/git-mentions">
  ...
  <Card title="URL Mentions" icon="globe" href="/3.17/features/at-mentions/url-mentions">
