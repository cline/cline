...
<Tip>
Focus Chain pairs well with [Deep Planning](/features/slash-commands/deep-planning). Use `/deep-plan` to create a detailed implementation plan, then let Focus Chain track progress as you execute it.
</Tip>
