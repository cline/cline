...
<Tip>
Auto Compact works beautifully with [Focus Chain](/core-workflows/task-management#focus-chain). When Focus Chain is enabled, todo lists persist across summarizations. Cline can work on long-horizon tasks spanning multiple context windows while staying on track.
</Tip>
