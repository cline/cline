...
[Learn more about interactive mode →](/cli/interactive-mode)
...
[Learn more about headless mode →](/cli/three-core-flows)
...
<Columns cols={2}>
  <Card title="Interactive Mode" icon="terminal" href="/cli/interactive-mode">
  ...
  <Card title="Configuration" icon="gear" href="/cli/configuration">
    Configure settings, rules, skills, and environment variables.
  </Card>
  
  <Card title="CLI Reference" icon="book" href="/cli/cli-reference">
