...
For automated workflows, scripts, or CI/CD pipelines, see [headless mode](/usage/cli-overview#headless-mode) instead.

## Prerequisites

Before using interactive mode, you need to have Cline CLI installed and authenticated. If you haven't done this yet, follow the [Installation & Setup guide](/getting-started/installing-cline) first.
