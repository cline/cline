...
<Note>
Parallel execution requires managing multiple Cline instances. See [Multi-instance workflows](/cli/three-core-flows#3-multi-instance-run-parallel-agents) for details.
</Note>
