...
<Note>
**New to Cline CLI?** This sample assumes you have already completed the [Installation Guide](https://docs.cline.bot/cli/installation) and authenticated with `cline auth`. If you haven't set up Cline CLI yet, please start there first.
</Note>
...
- **Cline CLI** installed and authenticated ([Installation Guide](https://docs.cline.bot/cli/installation))
...
- [CLI Installation Guide](https://docs.cline.bot/cli/installation)
- [CLI Reference Documentation](https://docs.cline.bot/cli/cli-reference)
- [Headless Mode](https://docs.cline.bot/cli/three-core-flows)
