  ...
  cline-pr-review:
    ...
    steps:
      ...
      - name: Install Cline CLI
        run: npm install -g @clinebot/cli
      ...
      - name: Review PR with Cline
        ...
        run: |
          clite --auto-approve true 'You are a GitHub PR reviewer for this repository. Your goal is to give the PR author helpful feedback and give maintainers the context they need to review efficiently.
...
### Authentication
```bash
clite auth --provider anthropic --apikey "..."
```
