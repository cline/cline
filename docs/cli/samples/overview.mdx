...
<CardGroup cols={1}>
  <Card 
    ...
    icon="layer-group" 
    href="/cli/samples/model-orchestration"
  >
  ...
  <Card 
    ...
    icon="code-branch" 
    href="/cli/samples/worktree-workflows"
  >
  ...
  <Card 
    ...
    href="/cli/samples/github-issue-rca"
  >
  ...
  <Card 
    ...
    icon="github" 
    href="/cli/samples/github-integration"
  >
  ...
  <Card 
    ...
    href="/cli/samples/github-pr-review"
  >
...
- [CLI Installation Guide](/cli/installation)
- [CLI Reference Documentation](/cli/cli-reference)
