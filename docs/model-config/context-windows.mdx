...
2. **File contents** - Any files you've shared or Beadsmith has read
3. **Tool outputs** - Results from executed commands
4. **System prompts** - Beadsmith's instructions (minimal impact)
...
Beadsmith can automatically summarize long conversations:
...
**A:** Beadsmith shows token usage in the interface. Watch for the context meter approaching limits.

### Q: What happens when I exceed the context limit?
**A:** Beadsmith will either:
