...
For new users, telemetry is enabled by default to help us improve Cline, but it's entirely optional:

-   When you install our VS Code extension, you'll see a message about our anonymous telemetry with an easy option to opt out
