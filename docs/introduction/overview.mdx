---
title: "Overview"
description: "An introduction to Beadsmith, your AI-powered coding agent for modern development."
---

## Open Source AI Coding, Uncompromised

Beadsmith gives you direct, transparent access to frontier AI with no limits, no surprises, and no model ecosystem lock-in. See every decision. Choose any model. Control your costs.

<CardGroup cols={1}>
  <Card title="Complete Transparency" icon="eye">
    Watch in real-time as Beadsmith reads files, considers approaches, and proposes changes. Every decision is visible, every edit reviewable before it's made.
  </Card>
  ...
  <Card title="Zero Trust by Design" icon="lock">
    Your code never touches our servers. Beadsmith runs entirely client-side with your API keys. Open source means your security team can review every line.
  </Card>
</CardGroup>
...
Beadsmith explores your codebase and works with you to create comprehensive plans before writing code, ensuring it understands the full context of your project.

<Tabs>
  <Tab title="Plan Mode" icon="lightbulb">
    For complex tasks, Beadsmith explores your codebase, asks clarifying questions, and creates detailed implementation plans before making changes.
  ...
  <Tab title="Act Mode" icon="play">
    Once you approve the plan, Beadsmith implements the solution with full transparency and control.
...
<AccordionGroup>
  ...
  <Accordion title="Workflow Optimization" icon="bolt">
    <div style={{ display: 'grid', gap: '1rem', marginTop: '0.5rem' }}>
      ...
      <div>
        <strong><a href="/features/dictation">Dictation</a></strong> • Speak naturally to Beadsmith for rapid planning and complex requirements
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="Extensions & Integrations" icon="plug">
    <div style={{ display: 'grid', gap: '1rem', marginTop: '0.5rem' }}>
      ...
      <div>
        <strong><a href="/exploring-beadsmiths-tools/remote-browser-support">Remote Browser</a></strong> • Test and interact with web applications through browser automation
      </div>
    </div>
  </Accordion>
  ...
  <Accordion title="Customization & Control" icon="gear">
    <div style={{ display: 'grid', gap: '1rem', marginTop: '0.5rem' }}>
      <div>
        <strong><a href="/features/beadsmith-rules">.beadsmithrules</a></strong> • Define project-specific instructions including coding standards and patterns
      </div>
      <div>
...
## Why Developers Choose Beadsmith
...
<CardGroup cols={2}>
  ...
  <Card title="Future-Proof by Design" icon="rocket">
    New model released? Use it immediately. Beadsmith works with multiple AI providers.
  </Card>
