...
| --- | --- | --- |
| `.clineignore` | Deprecating soon | Block Ignored File Access plugin |
| Explain Changes | Deprecated | Ask Cline for an explanation |
| Focus Chain | Deprecated | No direct replacement |
