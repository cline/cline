...
1. Click **Settings** (top right of Beadsmith chat)
...
-   **Switch to bash** (solves most instances)
    ...
    1. Within Beadsmith, left-click the **Settings** button in the top right-hand corner of the chat window
...
-   Select **"WSL Bash"** in Beadsmith settings, under **"Terminal Settings"**
