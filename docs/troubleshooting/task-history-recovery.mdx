...
description: "How to recover and reconstruct your Beadsmith task history"
---

Sometimes when you update Beadsmith or when certain settings change, you might lose access to your previous tasks. This guide will help you recover and reconstruct your Beadsmith task history, so you can regain access to your important conversations and work.
...
<Steps>
	...
	<Step title="Run the recovery command">
		Type **"Beadsmith: Reconstruct Task History"** and select it.
	</Step>
	<Step title="Confirm the action">
		A confirmation prompt will appear. Click **Yes** to proceed.
	</Step>
	<Step title="Wait for reconstruction">
		Beadsmith will scan your task folders and rebuild the history index.
	</Step>
...
Beadsmith creates backups automatically. Find them in the `state/` folder:
...
Switching to a new computer? You can bring all your Beadsmith conversations with you. The process is the same whether you're using VS Code or a JetBrains IDE.

<Steps>
	<Step title="Locate and copy your Beadsmith data">
	...
	<Step title="Set up your new machine">
		On your **new machine**, install your IDE (VS Code or JetBrains) and the Beadsmith extension.
	</Step>
	...
	<Step title="Launch and verify">
		Open your IDE. Your task history should now appear in Beadsmith.
	</Step>
</Steps>
...
Run **"Beadsmith: Reconstruct Task History"** from the command palette. If that doesn't work, check if there's a backup file to restore.

### History lost after reinstalling VS Code
VS Code usually keeps extension data when uninstalled. Simply reinstall Beadsmith and run the recovery command.
...
1. **Open a GitHub issue** at [beadsmith/beadsmith](https://github.com/beadsmith/beadsmith/issues)
