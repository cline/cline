...
HOOKS INTEGRATION
       The CLI supports hooks, which let you inject custom logic into Cline's
       workflow at key moments. Hooks can validate operations before they
       execute, monitor tool usage, and shape AI decisions.
