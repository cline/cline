...
<Note>
**Source Code:** The complete implementation with the script is available at [src/samples/cli/github-issue-rca](https://github.com/cline/cline/tree/main/src/samples/cli/github-issue-rca)
</Note>
