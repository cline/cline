...
You can find the script on [GitHub](https://github.com/cline/cline/tree/main/src/samples/cli/github-issue-rca/analyze-issue.sh), or download it directly with:
...
You've built an autonomous GitHub issue analysis tool using Cline CLI. This sample demonstrates:
