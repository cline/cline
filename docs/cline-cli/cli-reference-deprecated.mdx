...
description: "Below command reference for Cline CLI < version 2.0.0, which may no longer be supported soon. For the latest, please refer to the latest version"
---
