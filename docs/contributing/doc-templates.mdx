...
Here's how the [Checkpoints](/features/checkpoints) doc follows this pattern:
...
The [Cline Tools Guide](/exploring-clines-tools/cline-tools-guide) follows this pattern:
