...
- [Install Cline](/getting-started/installing-cline): Set up Cline in VS Code, Cursor, Windsurf, JetBrains, and more
- [IDE](/usage/ide): Hands-on IDE tutorial for building a complete todo app with Cline
