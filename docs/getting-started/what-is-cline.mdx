...
| [Working with Files](/core-workflows/working-with-files) | Use @ mentions to reference files, folders, URLs, and git-aware workspace context in your prompts. |
| [Commands](/core-workflows/using-commands) | Keyboard shortcuts, slash commands, and command execution workflows. |
