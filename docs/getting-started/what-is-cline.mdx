...
<Frame>
  <img src="https://storage.googleapis.com/cline_public_images/after-installation.png" alt="Cline running in VS Code" />
</Frame>
...
<Steps>
  <Step title="Install Cline">
    Add Cline to VS Code, Cursor, or JetBrains from the extension marketplace.
  ...
  <Step title="Pick Your Model">
    ...
    [Model Setup →](/getting-started/selecting-your-model)
  </Step>
