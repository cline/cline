...
Now that you've installed Cline and selected a model, we can start working together!

Let's build something! This quick tutorial will show you Cline in action by creating a simple interactive website.

## Prerequisites

- **Cline installed** in your editor ([Install Guide](/getting-started/installing-cline))
- **AI model selected** ([Model Setup](/getting-started/model-selection-guide))
