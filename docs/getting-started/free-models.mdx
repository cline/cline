...
<Frame>
  <img src="/assets/free-models/free-models-vscode-cline-provider.png" alt="Free models listed under the Cline provider in VS Code" />
</Frame>

- **CLI**: Go to `/settings`, select **Cline** as your provider, and browse available free models.

<Frame>
  <img src="/assets/free-models/free-models-cli-cline-provider.png" alt="Free models listed under the Cline provider in the Cline CLI" />
</Frame>
...
<Frame>
  <img src="/assets/free-models/free-models-vscode-clinepass-provider.png" alt="Free models listed under the ClinePass provider in VS Code" />
</Frame>

- **CLI**: Go to `/settings`, select **ClinePass** as your provider.

<Frame>
  <img src="/assets/free-models/free-models-cli-clinepass-provider.png" alt="Free models listed under the ClinePass provider in the Cline CLI" />
</Frame>
