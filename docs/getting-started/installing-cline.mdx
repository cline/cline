...
<Steps>
  ...
  <Step title="Sign In">
    Click the **Sign In** button in the Cline interface
  ...
  <Step title="Try Your First Request">
    Copy and paste this into the Cline chat to create your first project:
    
    ```
    Hey Cline! Could you help me create a new project folder called "hello-world" 
    in my Cline directory and make a simple webpage that says "Hello World" in 
    big blue text?
    ```
    
    <Check>
    Watch Cline create the folder, write the HTML/CSS, and set up your first project!
    </Check>
  </Step>
</Steps>
