...
<Tabs>
  ...
  <Tab title="JetBrains IDEs">
    <Note>
    Cline for JetBrains works almost identically to VS Code, with all core features: diff editing, tools, multiple API providers, MCP servers, Cline rules and skills, and more.
    </Note>
  ...
  <Tab title="CLI">
    ...
    **Preview Release**: Cline CLI is currently in preview and only available for macOS and Linux. Windows support is coming soon.
    ...
    <Tip>
    Want to learn more? See the [Cline CLI documentation](/cli/getting-started) for advanced usage patterns like multi-instance development and CI/CD integration.
    </Tip>
  </Tab>
  <Tab title="Zed/Neovim (ACP via CLI)">
    ...
    **ACP (Agent Client Protocol)** lets you run Cline in any ACP-compatible editor via the CLI. This gives you full access to Cline's capabilities—including Skills, Hooks, and MCP integrations—in your preferred editor.
    ...
    <Tip>
    For full details on ACP editor integrations—including JetBrains ACP setup and troubleshooting—see the [ACP Editor Integrations](/cli/acp-editor-integrations) guide.
    </Tip>
  </Tab>
