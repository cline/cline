  ...
  <Tab title="VS Code/Cursor" icon="code">
    ...
    <Steps>
      ...
      <Step title="Search for Cline">
        Type **"Cline"** in the Extensions marketplace search bar3
        	<Frame>
            <img src="/assets/installation/extension-installation.png" alt="VS Code marketplace showing Cline extension" 
            />
          </Frame>
      </Step>
      ...
      <Step title="Access Cline">
        ...
        <Frame caption="Cline opened in VSCode">
        	<img
        		src="/assets/installation/after-installation.png"
      ...
      <Tab title="From IDE (Recommended)">
        <Steps>
          ...
          <Step title="Install Cline">
            ...
            <Frame>
            	<img
            		src="/assets/installation/jetbrains-installation.png"
          ...
          <Step title="Restart IDE">
            ...
            <Frame>
            	<img
            		src="/assets/installation/jetbrains-post-installation.png"
            		alt="JetBrains marketplace showing Cline plugin search results"
            	/>
            </Frame>
          </Step>
