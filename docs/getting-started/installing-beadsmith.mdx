---
title: "Installing Beadsmith"
description: "Get Beadsmith up and running in your favorite IDE with these simple installation steps"
---
...
<CardGroup cols={1}>
  <Card title="Create Your Account" icon="user-plus" href="https://app.beadsmith.bot/login">
    Sign up for a **free Beadsmith account** to get:
...
<Tabs>
  <Tab title="VS Code/Cursor" icon="code">
    <Frame>
      <img
      	src="https://storage.googleapis.com/beadsmith_public_images/vscode.png"
      	alt="VS Code logo"
    ...
    <Steps>
      ...
      <Step title="Search for Beadsmith">
        Type **"Beadsmith"** in the Extensions marketplace search bar
        	<Frame>
            <img src="https://storage.googleapis.com/beadsmith_public_images/extension-installation.png" alt="VS Code marketplace showing Beadsmith extension" 
            />
          </Frame>
      </Step>

      <Step title="Install">
        Click the **Install** button on the Beadsmith extension
        
        <Frame caption="VS Code marketplace with Beadsmith extension ready to install">
        	<img
        		src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/image%20(20).png"
        		alt="VS Code marketplace showing Beadsmith extension"
        	/>
        </Frame>
      </Step>

      <Step title="Access Beadsmith">
        After installation completes:
        - Click the **Beadsmith icon** in the Activity Bar, or
        - Open Command Palette (`Ctrl/Cmd + Shift + P`) → type **"Beadsmith: Open In New Tab"**

        <Frame caption="Beadsmith opened in VSCode">
        	<img
        		src="https://storage.googleapis.com/beadsmith_public_images/after-installation.png"
        		alt="Beadsmith opened in VSCode"
        	/>
        </Frame>
        
        <Warning>
        If VS Code shows "Running extensions might..." dialog, click **Allow**. If you don't see the Beadsmith icon, restart VS Code.
        </Warning>
      </Step>
    </Steps>

    <Check>
    **Installation Complete!** You should now see the Beadsmith interface in your editor. Time to sign in!
    </Check>
    ...
    **Plugin Installation Issues**
    ...
    If you can't find Beadsmith in the marketplace:
    - Make sure you're searching in the **Marketplace** tab (not Installed)
    - Try searching for "Beadsmith AI" or just "Beadsmith"
    ...
    **Plugin Not Appearing**
    ...
    If you don't see the Beadsmith tool window after installation:
    - Restart VS Code completely (File → Exit and reopen)
    - Check **View** → **Command Palette** → "Beadsmith: Open In New Tab"
    - Verify the plugin is enabled in **Extensions** view
    - Look for the Beadsmith icon in your Activity Bar (usually on the left side)
    ...
    **Common Issues**
    ...
    Need help? Join our [Discord community](https://discord.gg/beadsmith).
  ...
  <Tab title="JetBrains IDEs" icon="brain">
    <img
    	src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/jetbrains-logo.svg"
    	alt="JetBrains logo"
    	style={{ width: "200px", height: "auto", margin: "0 auto 20px auto", display: "block" }}
    />

    <Note>
    Beadsmith for JetBrains works almost identically to VS Code, with all core features: diff editing, tools, multiple API providers, MCP servers, Beadsmith rules/workflows, and more.
    </Note>
    ...
    <Tabs>
      <Tab title="From IDE (Recommended)">
        <Steps>
          ...
          <Step title="Install Beadsmith">
            Search for **"Beadsmith"** and click **Install**
            
            <Frame>
            	<img
            		src="https://storage.googleapis.com/beadsmith_public_images/jetbrains-installation.png"
            		alt="JetBrains marketplace showing Beadsmith plugin search results"
            	/>
            </Frame>
          </Step>
          ...
          <Step title="Restart IDE">
            ...
            <Frame>
            	<img
            		src="https://storage.googleapis.com/beadsmith_public_images/jetbrains-post-installation.png"
            		alt="JetBrains marketplace showing Beadsmith plugin search results"
            	/>
            </Frame>
          </Step>
      ...
      <Tab title="Browser Install">
        <Steps>
          <Step title="Visit Marketplace">
            Go to the [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/28247-beadsmith)
          </Step>
      ...
      <Tab title="Manual Install">
        <Steps>
          <Step title="Download Plugin">
            Download from the [marketplace page](https://plugins.jetbrains.com/plugin/28247-beadsmith)
          </Step>
    ...
    <Check>
    **Installation Complete!** Find Beadsmith in **View** → **Tool Windows** → **Beadsmith** (usually on the right side).
    </Check>
    ...
    **Plugin Not Appearing**
    ...
    - Check **View** → **Tool Windows** → **Beadsmith**
    - Verify the plugin is enabled in **Settings** → **Plugins** → **Installed** tab
    - Look for the Beadsmith icon in your IDE's tool window bar (usually on the right side)
  ...
  <Tab title="VSCodium/Windsurf" icon="terminal">
    ...
    <Steps>
      ...
      <Step title="Search for Beadsmith">
        Type **"Beadsmith"** in the marketplace search bar
      </Step>

      <Step title="Install by Author">
        Select **"Beadsmith" by saoudrizwan** and click **Install**
      </Step>
    ...
    <Check>
    **Installation Complete!** Look for the Beadsmith icon in your Activity Bar or use the Command Palette.
    </Check>
...
<Steps>
  <Step title="Open Beadsmith">
    Find and open Beadsmith in your editor:
    - **VS Code/Cursor/VSCodium/Windsurf:** Click the Beadsmith icon in the Activity Bar
    - **JetBrains:** Go to **View** → **Tool Windows** → **Beadsmith**
  </Step>

  <Step title="Sign In">
    Click the **Sign Up** button in the Beadsmith interface
    
    <Info>
    You'll be redirected to [app.beadsmith.bot](https://app.beadsmith.bot) to authenticate. After signing in, you'll automatically return to your editor.
    </Info>
    <Info>
    You'll be redirected to the Beadsmith authentication page to sign in with your account.
    </Info>
  </Step>

  <Step title="You're All Set!">
    <Check>
    **Congratulations!** You're all set to start using Beadsmith! 
    
    Beadsmith is now ready to help you build projects. 
    </Check>
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Ask Questions" icon="circle-question">
    Don't know something? Ask in Plan Mode! Beadsmith can explain concepts, debug errors, and guide you through tasks.
  </Card>
  ...
  <Card title="Speak Naturally" icon="comments">
    Use your own words—no need for technical jargon. Beadsmith will translate your ideas into code.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Join Our Discord" icon="discord" href="https://discord.gg/beadsmith">
  ...
  <Card title="Read the Docs" icon="book-open" href="/getting-started/selecting-your-model">
    Explore model selection guides and advanced features to get the most out of Beadsmith.
  </Card>
</CardGroup>
