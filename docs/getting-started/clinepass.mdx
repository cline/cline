...
| Model | Model ID | API model slug |
|-------|----------|----------------|
| GLM-5.2 | `glm-5.2` | `cline-pass/glm-5.2` |
| Kimi K2.7 Code | `kimi-k2.7-code` | `cline-pass/kimi-k2.7-code` |
| Kimi K2.6 | `kimi-k2.6` | `cline-pass/kimi-k2.6` |
| DeepSeek V4 Pro | `deepseek-v4-pro` | `cline-pass/deepseek-v4-pro` |
| DeepSeek V4 Flash | `deepseek-v4-flash` | `cline-pass/deepseek-v4-flash` |
| MiMo-V2.5 | `mimo-v2.5` | `cline-pass/mimo-v2.5` |
| MiMo-V2.5-Pro | `mimo-v2.5-pro` | `cline-pass/mimo-v2.5-pro` |
| MiniMax M3 | `minimax-m3` | `cline-pass/minimax-m3` |
| Qwen3.7 Max | `qwen3.7-max` | `cline-pass/qwen3.7-max` |
| Qwen3.7 Plus | `qwen3.7-plus` | `cline-pass/qwen3.7-plus` |
