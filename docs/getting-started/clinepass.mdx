...
| DeepSeek V4 Pro<sup>1</sup> | $0.99 | $2.97 | $0.033 | - |
| DeepSeek V4 Flash<sup>1</sup> | $0.33 | $0.99 | $0.0105 | - |
...
<sup>1</sup> DeepSeek V4 Pro and Flash use the simple average of DeepSeek's published [off-peak and peak rates](https://api-docs.deepseek.com/quick_start/pricing/).
