...
- **ClinePass**: a $9.99/month subscription provider with access to selected open coding models and 5x API rate limits.
...
- 5x API rate limits for longer agent sessions
- Curated open coding models including GLM, Kimi, DeepSeek, and MiMo

Subscribe from the [ClinePass dashboard](https://app.cline.bot/dashboard/subscription), then select **ClinePass** as your provider in Cline. See the [ClinePass guide](/getting-started/clinepass) for included models and reference pricing.
