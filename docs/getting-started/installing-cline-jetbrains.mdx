...
You can install Cline in any JetBrains IDE:

- **IntelliJ IDEA** (Community or Ultimate) - Best for Java and has excellent Node.js support
- **PyCharm** (Community or Professional) - Python development
- **WebStorm** - Web development
- **PhpStorm** - PHP development  
- **GoLand** - Go development
- **AndroidStudio** - Android development
- **CLion** - C/C++ development
- **RubyMine** - Ruby development
- **DataGrip** - Database development

If you're installing IntelliJ IDEA, the Community version is free and includes all the features you need. JetBrains tries to hide the Community edition download - look below the fold on their download page.

## Installation Methods

### JetBrains Marketplace (Recommended)

The fastest way to install Cline is directly from the JetBrains Marketplace:
...
3. **Search for Cline:**
   ...
   - Look for the plugin by saoudrizwan
4. **Install the Plugin:**
   - Click **Install** next to the Cline plugin
   - Restart your IDE when prompted

### Manual Installation from Disk

If you prefer to install manually or the Marketplace isn't working:
