...
description: "Get started with your first AI model in Beadsmith"
---

Beadsmith needs an AI model to understand your requests and write code. Think of it like choosing which expert to work with - different models have different strengths and costs.

## Quick Start: Choose Your Provider

The easiest way to get started is with **Beadsmith** as your provider:

1. **Open Beadsmith Settings**: Click the gear icon (⚙️) in the top-right corner of Beadsmith's chat
2. **Select "Beadsmith"** from the API Provider dropdown
3. **Choose a model** from the dropdown - we recommend starting with **Claude Sonnet 4.5** or **DeepSeek V3**

<Frame>
  <img src="https://storage.googleapis.com/beadsmith_public_images/step2-provider.png" alt="Select Beadsmith Provider" />
</Frame>

**That's it!** No API keys to manage, and you'll get access to multiple models.

<Tip>
**Free models available**: Beadsmith occasionally offers free inferencing through partner providers. When available, you'll see these options in your model dropdown.
</Tip>
...
3. Authorize Beadsmith in your browser
4. Choose your model
...
2. Paste it into the API Key field in Beadsmith settings
3. Choose your model
...
With your model configured, you're all set! In the next section, we'll walk you through completing your first task with Beadsmith and show you how to interact with the AI to write, debug, and refactor code.
