...
| Path | What |
|---|---|
| [`docs/drivecode/design/drive-wireframes/DRIVE-TAB.md`](../../design/drive-wireframes/DRIVE-TAB.md) | Discord IA in Slack chrome decision |
...
```text
Read: docs/drivecode/plans/cline-drivemode/LEADERSHIP-BRIEF.md
...
Smoke: open docs/drivecode/design/drive-wireframes/drive-tab-discord-slack.html in a browser
```