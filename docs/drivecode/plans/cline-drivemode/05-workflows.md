...
**Sources.** [00-vision.md](00-vision.md) “Senior-engineer tone”; cursor-drive `drive-persona` teaching posture; this repo’s review ELI5 practice ([docs/drivecode/reviews/](../../reviews/) when present).
...
| [`docs/drivecode/design/drive-wireframes/DRIVE-TAB.md`](../../design/drive-wireframes/DRIVE-TAB.md) | This repo's own IA decision; product forks closed in [DEC-open-product-forks](decisions/DEC-open-product-forks.md). |
