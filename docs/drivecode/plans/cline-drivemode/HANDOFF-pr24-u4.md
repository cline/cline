...
**Parent plan.** Dependency upgrades + primitives audit (`docs/drivecode/plans/cline-drivemode/13-deps-inventory.md`, `14-primitives-audit.md`).
...
| Drive product | Demo share producers beyond mermaid stub, mic wiring, WebRTC, recruit/graph | Separate drivemode feature PRs; see `docs/drivecode/plans/cline-drivemode/HANDOFF.md` |
