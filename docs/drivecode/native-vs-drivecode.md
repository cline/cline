...
| Privacy | Session storage norms | Privacy-strict: no transcript/audio persist without explicit debug flag | `plan` | [DRV-PRIVACY](./plans/cline-drivemode/features/DRV-PRIVACY.md); [HANDOFF.md](./HANDOFF.md) |
...
- Repo handoff: [HANDOFF.md](./HANDOFF.md)
