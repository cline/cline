...
-   `grok-code-fast-1` - xAI's Grok Code Fast 1 model - optimized for coding tasks with 131K context window
...
-   **Coding Optimization:** The `grok-code-fast-1` model is specifically optimized for coding tasks, providing enhanced performance for programming-related queries and tasks.
