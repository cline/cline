...
-   `grok-4` (Recommended) - xAI's latest Grok-4 model with 262K context window and image support

#### Grok-3 Models

-   `grok-3` - xAI's Grok-3 model with 131K context window
-   `grok-3-fast` - xAI's Grok-3 fast model with 131K context window
-   `grok-3-mini` - xAI's Grok-3 mini model with 131K context window
-   `grok-3-mini-fast` - xAI's Grok-3 mini fast model with 131K context window
-   `grok-3-beta` - xAI's Grok-3 beta model with 131K context window
