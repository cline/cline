---
title: "Z AI (Zhipu AI)"
description: "Learn how to configure and use Z AI's GLM-4.5 models with Beadsmith. Experience advanced hybrid reasoning, agentic capabilities, and open-source excellence with regional optimization."
---
...
### Configuration in Beadsmith

1.  **Open Beadsmith Settings:** Click the settings icon (⚙️) in the Beadsmith panel.
...
- Works exclusively through coding tools like Beadsmith
...
<Frame>
  <img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/zAI-coding-plan.png" alt="zAI subscription page showing GLM Coding Lite and Pro plans with pricing" />
</Frame>

#### Setting up GLM Coding Plans

To use the GLM Coding Plans with Beadsmith:
...
3. **Configure in Beadsmith:** Open Beadsmith settings, select "Z AI" as your provider, and paste your API key into the "Z AI API Key" field.

<Frame>
  <img src="https://storage.googleapis.com/beadsmith_public_images/docs/assets/zAI-provider.png" alt="Beadsmith settings with zAI provider selected and API key field highlighted" />
</Frame>

The setup connects your subscription directly to Beadsmith, giving you access to GLM-4.5's tool-calling capabilities optimized for coding workflows.
