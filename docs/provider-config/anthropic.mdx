...
#### Claude 5 Series
-   `claude-sonnet-5` (Recommended) - Latest Sonnet with extended thinking support
-   `claude-sonnet-5:1m` - 1M context window variant with tiered pricing


#### Claude 4.5 Series
-   `claude-sonnet-4-5-20250929` (Recommended) - Fast, affordable model with reasoning support
