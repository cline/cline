...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "Beadsmith").
4. **Copy the Key:** **Important:** Copy the API key _immediately_. You will not be able to see it again. Store it securely.

### Supported Models

Beadsmith supports the following Fireworks AI models:
