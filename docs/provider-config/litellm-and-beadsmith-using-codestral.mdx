---
title: "LiteLLM & Beadsmith (using Codestral)"
description: "Learn how to set up and run LiteLLM with Beadsmith using the Codestral model. This guide covers Docker setup, configuration, and integration with Beadsmith."
---

### Using LiteLLM with Beadsmith

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with Beadsmith.
...
2. **Setup Beadsmith**
    ...
    Once the LiteLLM server is up and running you can set it up in Beadsmith:
...
-   [Beadsmith Discord Community](https://discord.gg/beadsmith)
