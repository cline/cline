...
<Steps>
  <Step title="Open Cline Settings">
    Click the settings gear icon (⚙️) in the top-right corner of the Cline extension.
  </Step>
...
- **Privacy**: Cline only requests the permissions necessary to make API calls on your behalf. Your OpenAI credentials are never stored by Cline.
- **Usage & Billing**: API usage is billed to your OpenAI account according to your subscription plan.
- **Rate Limits**: Rate limits are determined by your OpenAI account tier, not by Cline.
