...
description: "Connect your OpenAI account to Cline via OAuth for seamless access to OpenAI provider."
---
...
- [Cline provider](/getting-started/cline-provider): Fastest built-in setup option
