---
title: "Baseten"
description: "Learn how to configure and use Baseten's Model APIs with Beadsmith. Access frontier open-source models with enterprise-grade performance, reliability, and competitive pricing."
---
...
3.  **Create a Key:** Generate a new API key. Give it a descriptive name (e.g., "Beadsmith").
...
**IMPORTANT: For Kimi K2 Thinking:** To use the `moonshotai/Kimi-K2-Thinking` model, you must enable **Native Tool Call (Experimental)** in Beadsmith settings. This setting allows Beadsmith to call tools through their native tool processor and is required for this reasoning model to function properly.

### Supported Models

Beadsmith supports all current models under Baseten Model APIs, including:
...
-   **Dynamic Model Updates:** Beadsmith automatically fetches the latest model list from Baseten, ensuring access to new models as they're released in real time.
