...
### Cheaper Inference
Cheaper Inference is an OpenAI-compatible gateway that serves models from several labs with one API key.
Each model costs 15–60% less than the list price of its lab.

**Website:** [https://cheaperinference.com](https://cheaperinference.com)

#### Basic Setup

1. Create an account at [cheaperinference.com/signup](https://cheaperinference.com/signup).
2. Create an API key. Keys start with `ci_live_`.
3. In Cline, choose **Cheaper Inference** and paste the key.

See the [Cheaper Inference model list](https://cheaperinference.com/#models) for the available model IDs.
