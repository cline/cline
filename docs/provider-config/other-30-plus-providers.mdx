...
### ainetcafe
ainetcafe serves Kimi K3 from its own cluster at the model's native MXFP4 precision, with prompt caching, tool calling and image input, about 30% under the list price.

**Website:** [https://ainetcafe.com/k3/](https://ainetcafe.com/k3/)

#### Basic Setup

1. Sign up at [microquickjs.com](https://microquickjs.com/register?lng=en) (small sign-up credit), then open **Token Management** and create a key.
2. In Cline, choose **ainetcafe** and provide the key.
3. Select `Kimi-K3` as the model. Setup notes for Cline are at [ainetcafe.com/k3/guides/cline.html](https://ainetcafe.com/k3/guides/cline.html).
