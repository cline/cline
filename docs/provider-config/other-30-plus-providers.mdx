...
- [Providers](#providers)
  ...
  - [SaladCloud AI Gateway](#saladcloud-ai-gateway)
  - [Together](#together)
...
SaladCloud AI Gateway provides an OpenAI-compatible endpoint for hosted open models. Its Qwen3.6 35B-A3B model is designed for agentic tasks, complex reasoning, and code generation.

**Website:** [https://salad.com/ai-gateway](https://salad.com/ai-gateway)

**Documentation:** [Getting Started](https://docs.salad.com/ai-gateway/tutorials/getting-started) · [Model Reference](https://docs.salad.com/ai-gateway/reference/models)

#### Basic Setup

1. Request closed-beta access and create a Salad API key.
2. In Cline, choose **OpenAI Compatible**.
3. Set **Base URL** to `https://ai.salad.cloud/v1`.
4. Paste your Salad API key and set **Model ID** to `qwen3.6-35b-a3b`.
5. In **Model Configuration**, set the context window and maximum output to `262144`, and enable image support.
