...
### GPTZZZ
GPTZZZ is an OpenAI-compatible gateway serving OpenAI models.

**Website:** [https://gptzzz.ai](https://gptzzz.ai)

#### Basic Setup

1. Create/sign in at [gptzzz.ai](https://gptzzz.ai) and generate an API key in the console.
2. In Cline, choose **GPTZZZ** and provide the key.
3. Model IDs differ between account groups; copy the exact ID from the console or `GET /v1/models`.
