...
### API Route
API Route is an aggregating gateway providing unified access to Claude, OpenAI, DeepSeek, and Gemini models with low latency and pay-as-you-go billing.

**Website:** [https://www.api-route.com](https://www.api-route.com)

#### Basic Setup

1. Sign in to [API Route Console](https://www.api-route.com).
2. Generate an API Key in the **Tokens** section.
3. In Cline, select **API Route** and enter your key.
