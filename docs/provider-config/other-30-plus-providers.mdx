...
### Inference APIs
Inference APIs hosts open-weight models (DeepSeek V4, GLM 5.3, Kimi K2.7, MiniMax M3, GPT-OSS, Qwen3-VL) in the United States with zero data retention, billed per token from a prepaid balance.

**Website:** [https://inferenceapis.com](https://inferenceapis.com)

#### Basic Setup

1. Create an account at [inferenceapis.com/register](https://inferenceapis.com/register).
2. Create a key on the **API Keys** page.
3. In Cline, choose **Inference APIs** and enter the key.
