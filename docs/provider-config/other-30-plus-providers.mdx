...
### Scalattice
Scalattice is an OpenAI-compatible inference marketplace for open-weight models.

**Website:** [https://scalattice.cloud](https://scalattice.cloud)

#### Basic Setup

1. Create a developer key from the [Scalattice docs](https://scalattice.cloud/docs/developers).
2. In Cline, choose **Scalattice** and paste the key.
3. Pick a catalog model such as `qwen-3-14b`, or keep the default.
