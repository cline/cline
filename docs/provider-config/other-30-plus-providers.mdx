...
### LLMTR
LLMTR is a Turkey-based OpenAI-compatible AI gateway that exposes Turkey-hosted models alongside proxied global models through a single API key.

**Website:** [https://llmtr.com/](https://llmtr.com/)

#### Basic Setup

1. Create/sign in to your LLMTR account.
2. Generate an API key from the dashboard.
3. In Cline, choose **LLMTR** and paste the key.
