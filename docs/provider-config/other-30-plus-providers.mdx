...
### Novita AI
Novita AI provides OpenAI-compatible hosted model APIs.

**Website:** [https://novita.ai/](https://novita.ai/)

#### Basic Setup

1. Sign in to Novita AI and create an API key.
2. Confirm the model ID you want to use from the Novita model catalog.
3. In Cline, choose **Novita AI** and enter the API key.
