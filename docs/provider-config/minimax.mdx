...
-   `MiniMax-M2.7-highspeed` - High-speed version of M2.7 for low-latency scenarios ($0.30/$1.20 per 1M tokens)
-   `MiniMax-M2.5` - Previous flagship with 192K context, prompt caching, and reasoning support ($0.30/$1.20 per 1M tokens)
-   `MiniMax-M2.5-highspeed` - High-speed version of M2.5 ($0.30/$1.20 per 1M tokens)
...
-   **Prompt Caching:** M2.7, M2.5, and M2.1 models support prompt caching for reduced costs on repeated queries.
