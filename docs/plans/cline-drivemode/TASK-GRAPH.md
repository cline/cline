...
Also in this phase (schemas + compile stubs, not full UI): home/graph types per [schemas/README.md](schemas/README.md), [DRV-DRIVEAGENT-HOME](features/DRV-DRIVEAGENT-HOME.md) compile fixture, [DRV-GATES](features/DRV-GATES.md) taxonomy enums (UI later).
