...
import (
	...
	"github.com/beadsmith/cli/pkg/hostbridge"
)
...
func main() {
	rootCmd := &cobra.Command{
		Use:   "beadsmith-host",
		Short: "Beadsmith Host Bridge Service",
		Long:  `A simple host bridge service that provides host operations for Beadsmith Core.`,
		RunE:  runServer,
	}
...
func runServer(cmd *cobra.Command, args []string) error {
	...
	// Start server
	if verbose {
		log.Printf("Starting Beadsmith Host Bridge on port %d", port)
	}
