...
python3 .agents/skills/webapp-testing/scripts/test_reconnaissance.py .

# 2. Generate: screen-design 산출물에서 테스트 자동 생성
python3 .agents/skills/webapp-testing/scripts/test_generator.py . --mode all

# 3. Run: Vitest 단위테스트 실행
cd nextjs && npm run test:run

# 4. Report: Coverage 리포트 생성
python3 .agents/skills/webapp-testing/scripts/coverage_reporter.py .
```
...
- 재사용 가능한 스크립트 → `.agents/skills/webapp-testing/scripts/`에 배치
...
```bash
python3 .agents/skills/webapp-testing/scripts/test_generator.py . --mode screen-states
```
...
```bash
python3 .agents/skills/webapp-testing/scripts/test_generator.py . --mode flows
```
...
```bash
python3 .agents/skills/webapp-testing/scripts/test_generator.py . --mode coverage-gaps
```
...
# 특정 화면만 정찰
python3 .agents/skills/webapp-testing/scripts/test_reconnaissance.py . --screens SCR-AUTH-01,SCR-APP-01

# 다른 포트
python3 .agents/skills/webapp-testing/scripts/test_reconnaissance.py . --base-url http://localhost:5173
```
...
# 지정 경로
python3 .agents/skills/webapp-testing/scripts/coverage_reporter.py . /tmp/coverage.md
```
...
```bash
python3 .agents/skills/webapp-testing/scripts/wireframe_buttons.py add <page.tsx>
python3 .agents/skills/webapp-testing/scripts/wireframe_buttons.py remove <page.tsx>
```
