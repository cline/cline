...
- [ ] Add entry to `.agents/skills/skills.json`
...
### Step 4: 스크립트 분리 및 복사
- [ ] Identify reusable scripts → copy to `.agents/skills/<name>/scripts/`
...
- [ ] Verify `.claude/skills` is a symlink to `../.agents/skills`
- [ ] Verify `.codex/skills` is a symlink to `../.agents/skills`
