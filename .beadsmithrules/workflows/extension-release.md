The goal of this workflow is to take a changeset for a release of Beadsmith, an autonomous coding agent extension that plugs right into your IDE, and write the updated announcement component, and the updated changelog. 
...
claude-dev@3.14.0
Minor Changes
77c9863: create beadsmithrules folder if its currently a file and creating new rule
...
df37f29: Add support for custom API request timeout. Previously, timeouts were hardcoded to 30 seconds for providers like Ollama or 15 seconds for OpenRouter and Beadsmith. Now users can set a custom timeout value in milliseconds through the settings interface.
...
2fe2405: Migrate Beadsmith Tools Section to new docs
...
4196c14: add cache ui for open router and beadsmith provider
...
-   Add support for custom API request timeout. Timeouts were 15-30s, but can now be configured via settings for OpenRouter/Beadsmith & Ollama (Thanks @WingsDrafterwork!)
...
-   Add cache ui for open router and beadsmith provider
...
-   Create beadsmithrules folder creating new rule if it's needed
	...
	return (
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				...
				<li>
					<b>/newrule command:</b> New slash command to have beadsmith write your .beadsmithrules for you based on your
					workflow.
				</li>
				<li>
				...
				<li>Added support for rendering LaTeX in message responses. (Try asking Beadsmith to show the quadratic formula)</li>
			</ul>
			<Accordion isCompact className="pl-0">
				<AccordionItem
					...
					<ul style={ulStyle}>
						<li>
							<b>Global Beadsmith Rules:</b> store multiple rules files in Documents/Beadsmith/Rules to share between
							projects.
						</li>
						<li>
							<b>Beadsmith Rules Popup:</b> New button in the chat area to view workspace and global beadsmith rules files
			...
			<ul style={{ margin: "0 0 8px", paddingLeft: "12px" }}>
				...
				<li>
					<b>Edit Beadsmith's changes before accepting!</b> When he creates or edits a file, you can modify his
					changes directly in the right side of the diff view (+ hover over the 'Revert Block' arrow button in
					the center to undo "<code>{"// rest of code here"}</code>" shenanigans)
				</li>
				<li>
					New <code>search_files</code> tool that lets Beadsmith perform regex searches in your project, letting
					him refactor code, address TODOs and FIXMEs, remove dead code, and more!
				</li>
				<li>
					When Beadsmith runs commands, you can now type directly in the terminal (+ support for Python
					environments)
				</li>
			</ul>*/}
			<div style={hrStyle} />
			<p style={linkContainerStyle}>
				Join us on{" "}
				<VSCodeLink style={linkStyle} href="https://x.com/beadsmith">
					X,
				</VSCodeLink>{" "}
				<VSCodeLink style={linkStyle} href="https://discord.gg/beadsmith">
					discord,
				</VSCodeLink>{" "}
				or{" "}
				<VSCodeLink style={linkStyle} href="https://www.reddit.com/r/beadsmith/">
					r/beadsmith
				</VSCodeLink>
				for more updates!
			</p>
...
75143a7: Add the ability to fetch from global beadsmith rules files
Patch Changes
...
-   Add Beadsmith rules popover under the chat field, allowing you to easily add, enable & disable workspace level or global rule files
-   Add new slash command menu letting you type “/“ to do quick actions like creating new tasks
-   Add ability to edit past messages, with options to restore your workspace back to that point
-   Allow sending a message when selecting an option provided by the question or plan tool
-   Add command to jump to Beadsmith's chat input
...
const Announcement = ({ version, hideAnnouncement }: AnnouncementProps) => {
	...
	return (
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				<li>
					<b>Global Beadsmith Rules:</b> store multiple rules files in Documents/Beadsmith/Rules to share between projects.
				</li>
				<li>
					<b>Beadsmith Rules Popup:</b> New button in the chat area to view workspace and global beadsmith rules files to plug
			...
			<ul style={ulStyle}>
				<li>
					<b>Model Favorites:</b> You can now mark your favorite models when using Beadsmith & OpenRouter providers for
					quick access!
				</li>
				<li>
					<b>Faster Diff Editing:</b> Improved animation performance for large files, plus a new indicator in chat
					showing the number of edits Beadsmith makes.
				</li>
				<li>
					<b>New Auto-Approve Options:</b> Turn off Beadsmith's ability to read and edit files outside your workspace.
				</li>
			</ul>
			{/*
			// Leave this here for an example of how to structure the announcement
...
Also, SUPER important: For any external contributors that aren't part of the beadsmith github organization, we always want to add a (Thanks @username!) at the end of the changelog to attribute them properly. We're an open source project and it's ethical to do this.
</important_note>
...
# Beadsmith Release Process - Detailed Sequence of Steps
...
4. For each commit hash in the auto-generated changelog entries:
   ...
   c. Check if the contributor is external to determine if attribution is needed:
      ...
      # Check if user is a member of the Beadsmith organization
      ...
      gh api "orgs/beadsmith/members" --jq "map(.login)" | grep -i "pashpashpash"
      ```
