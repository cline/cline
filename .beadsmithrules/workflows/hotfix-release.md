...
- Description of fix 1 https://github.com/beadsmith/beadsmith/pull/{PR_NUMBER}
- Description of fix 2 https://github.com/beadsmith/beadsmith/pull/{PR_NUMBER}
```
...
Remind the user to:
1. Manually trigger the publish release GitHub Action at: https://github.com/beadsmith/beadsmith/actions/workflows/publish.yml (paste `v{VERSION}` as the tag)
