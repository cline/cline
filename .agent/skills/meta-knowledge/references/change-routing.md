...
- `.agent/skills/<skill-name>/assets/templates/*`
...
- `.agent/skills/meta-knowledge/assets/templates/new-skill-proposal.md`
...
- `AGENTS.md`
- future `.agent/.aidlc-rule-details/*`
