...
Identify the SMEs (subject matter experts) for the code being changed on the current branch based on **domain expertise** and git history.
...
3. **Identify the domain/feature area** being changed:
   ...
   - This semantic understanding is crucial for finding the right SMEs
...
8. Present the top 5 SMEs as an ordered list
...
Do NOT ask questions - analyze the changes, identify the domain, and output the SME list.
