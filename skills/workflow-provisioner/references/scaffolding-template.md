...
The `.agent/` tree is the canonical project-owned workflow namespace. `.claude/` and `.codex/` only expose runtime adapters and must not hold copied skill sources.
...
### Skills Runtime
- [ ] `.agent/.aidlc-rule-details/` exists as the project-owned vendored rule tree
- [ ] `.agent/skills/` exists as the only editable skill source
- [ ] `.agent/workflow-bundle/` exists as project-owned workflow metadata
- [ ] `.claude/skills` symlink points to `../.agent/skills`
- [ ] `.codex/skills` symlink points to `../.agent/skills`
...
- [ ] Project-owned workflow assets do not spill outside the canonical `.agent/` roots
