You have access to the `gh` terminal command. I already authenticated it for you. Please review it to use the PR that I asked you to review. You're already in the `bedrockCoder` repo.
...
```typescript
await vscode.commands.executeCommand("bedrock-coder.SidebarProvider.focus")
