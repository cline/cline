...
`dist/extension.js` as CommonJS under Node, and the standalone `bedrock-coder-core` is a
...
| `NODE_PATH=... node bedrock-coder-core.js` | The standalone core is launched by Node, not bun. |
