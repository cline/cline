...
async function main() {
	...
	const indexContent = [
		"// Auto-generated index file for cline proto types",
		"// Generated by build-protos.js",
		...protoFiles.map((file) => `export * from "./${path.basename(file, ".proto")}"`),
	]
	const indexPath = path.join(TS_OUT_DIR, "index.ts")
