...
-   e52dd22: Fix flicker on external files icon
-   9a5a0e1: Add support for Azure's DeepSeek model.
-   4d696f3: gRPC over vscode message bus to make messaging better
-   3ef81cd: Refactor the function constructNewFileContent using a state switching mechanism, and fix the issue of inaccurate SEARCH-REPLACE delimiters generated by some large models through lookahead processing
...
-   e8b2169: Support baseURL for Google Gemini provider
-   6c5b99d: Safer check for xAI reasoning content
-   570646f: MCP ImageContent as tool result
