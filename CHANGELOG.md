...
- 4dd6c6d: fix: add chat output on skill use
- 79d88f7: Adding telemetry for background exec terminal
- 97a35d3: fix: removes retry message from UI after retry succeeds
- 0133b5d: add claude 4.5 opus into sap provider.
- 4d092bf: Fix crash when the Context Menu has a type but no options
- dca0a8f: Throttle the remote config fetch
- 361494d: Improve history view filter menu
