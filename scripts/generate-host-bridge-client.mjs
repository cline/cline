...
import * as grpcJs from "@generated/grpc-js/index"
import { StreamingCallbacks } from "@hosts/host-provider-types"
import * as proto from "@shared/proto/index"
...
export class ${serviceName}ClientImpl 
	extends BaseGrpcClient<any> 
	implements ${serviceName}ClientInterface {

	protected createClient(channel: Channel): any {
		return createClient(grpcJs.host.${serviceName}Service as any, channel)
	}
