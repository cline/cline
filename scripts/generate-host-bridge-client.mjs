...
const EXTERNAL_CLIENT_FILE = path.resolve("src/generated/standalone/host-bridge-clients.ts")
// Contains the clients impls for the external host bridge clients (using nice-grpc).
...
async function generateVscodeClientFile(hostServices) {
	...
	const content = `// GENERATED CODE -- DO NOT EDIT!
// Generated by scripts/generate-host-bridge-client.mjs
import { createServiceRegistry, HostServiceHandlerConfig  } from "@hosts/vscode/hostbridge-grpc-service"
${imports.join("\n")}
${clientImplementations.join("\n\n")}
...
function generateVscodeClientImplementation(serviceName, serviceDefinition) {
	...
	// Generate the class
	return `// Create ${name} service registry
