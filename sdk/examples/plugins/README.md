...
| [computer-use/](./computer-use/) | Deadline-aware hybrid sync/async tool + multimodal polling | Controls a qbt-backed computer through a normal plugin tool. Fast actions return screenshots directly; slow actions become durable jobs, steer on completion, and return their screenshot through `computer_poll`. |
