import type { RuntimeCapabilities } from "@cline/core/hub-runtime";
...
vi.mock("@cline/core/hub-runtime", async (importOriginal) => ({
	...(await importOriginal<typeof import("@cline/core/hub-runtime")>()),
...
describe("hub runtime wiring", () => {
	...
	it("provides an executable headless completion tool to the real yolo runtime builder", async () => {
		...
		const { DefaultRuntimeBuilder } = await import("@cline/core/hub-runtime");
