...
| Render shared welcome artwork, hero heading, quick actions, or session status | `@cline/ui/theme/tokens.css`, `@cline/ui/components.css`, and `@cline/ui` | No | React 18.3 or 19 |
