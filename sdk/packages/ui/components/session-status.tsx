...
export function SessionStatus({
	...
	return (
		<output
			className={[
				"cline-ui-session-status inline-flex items-center gap-1.5 text-xs leading-none text-muted-foreground",
		...
		>
			<span
				aria-hidden="true"
				className="cline-ui-session-status__dot size-2 shrink-0 rounded-[999px]"
			/>
