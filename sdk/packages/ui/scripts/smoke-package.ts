...
const importCheck =
	'import { Conversation, Message } from "@cline/ui/components/agent-chat"; const agentChatCss = import.meta.resolve("@cline/ui/components/agent-chat.css"); const markdownCss = import.meta.resolve("@cline/ui/components/markdown.css"); const scopedTokens = import.meta.resolve("@cline/ui/theme/scoped-tokens.css"); const tokens = import.meta.resolve("@cline/ui/theme/tokens.css"); if (!Conversation || !Message || !agentChatCss || !markdownCss || !scopedTokens || !tokens) process.exit(1);';
