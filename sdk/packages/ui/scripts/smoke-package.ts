...
import { Button, ConfirmDialog, SearchCombobox, SessionStatus } from "@cline/ui";
...
if (!Button || !ConfirmDialog || !SearchCombobox || !SessionStatus || !Conversation || !Message || !controlsCss || !css || !markdown || !scopedTokens || !tokens) process.exit(1);
