...
import { AgentComposer, AgentSurface } from "@cline/ui";
...
const chatCss = import.meta.resolve("@cline/ui/components/agent-chat.css");
const markdownCss = import.meta.resolve("@cline/ui/theme/markdown.css");
...
if (!AgentComposer || !AgentSurface || !Conversation || !Message || !controlsCss || !chatCss || !markdownCss || !tokens || !scopedTokens) process.exit(1);
