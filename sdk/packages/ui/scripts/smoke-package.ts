...
if (!AgentApprovalCard || !AgentComposer || !AgentHeroHeading || !AgentQuickActions || !AgentSurface || !Button || !SearchCombobox || !SessionStatus || !Conversation || !Message) process.exit(1);
