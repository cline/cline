...
import { AgentHeroHeading, AgentQuickActions, AgentSurface, Button, SearchCombobox, SessionStatus } from "@cline/ui";
...
if (!AgentHeroHeading || !AgentQuickActions || !AgentSurface || !Button || !SearchCombobox || !SessionStatus || !Conversation || !Message || !controlsCss || !css || !markdown || !scopedTokens || !tokens) process.exit(1);
