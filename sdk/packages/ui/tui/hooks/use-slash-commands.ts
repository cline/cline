...
export function useSlashCommands(input: {
	workflowSlashCommands: InteractiveTerminalUiProps["workflowSlashCommands"];
	loadAdditionalSlashCommands: InteractiveTerminalUiProps["loadAdditionalSlashCommands"];
	canFork: boolean;
}) {
	...
	const [additionalSlashCommands, setAdditionalSlashCommands] = useState<
		InteractiveTerminalUiProps["workflowSlashCommands"] | undefined
