...
export function useRuntimeDialogBridge(input: {
	setToolApprover: InteractiveTerminalUiProps["setToolApprover"];
	setAskQuestion: InteractiveTerminalUiProps["setAskQuestion"];
	setModeChangeNotifier: InteractiveTerminalUiProps["setModeChangeNotifier"];
