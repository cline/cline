...
/**
 * Boot the host-driven interactive terminal UI on the current terminal.
 * The host owns the runtime: sessions, providers, persistence, approvals.
 * This function only creates the OpenTUI renderer and mounts the shared app.
 */
export async function runInteractiveTerminalUi(
	...
	const initialThemeId = getInitialThemeId(props.themePreference);
