...
export function SessionProvider(props: {
	config: InteractiveTerminalUiProps["config"];
	initialEntries?: ChatEntry[];
	initialUsage?: {
		totalTokens: number;
		totalCost: number;
	};
	onRunningChange: InteractiveTerminalUiProps["onRunningChange"];
	onAutoApproveChange: InteractiveTerminalUiProps["onAutoApproveChange"];
	onCompactionModeChange: InteractiveTerminalUiProps["onCompactionModeChange"];
