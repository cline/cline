...
export function AgentHeroHeading({ ariaLabel, className, cycleMs = 2600, verbs = DEFAULT_VERBS, }) {
    ...
    const accessibleText = ariaLabel ?? `What would you like to ${availableVerbs[0] ?? "build"}?`;
    return (_jsxs("h1", { className: cx("cline-ui-hero-heading", className), children: [_jsx("span", { className: "cline-ui-sr-only", children: accessibleText }), _jsxs("span", { "aria-hidden": "true", children: ["What would you like to", " ", _jsx("span", { className: "cline-ui-hero-heading__word", children: verb.split("").map((character, index) => (_jsx("span", { className: "cline-ui-hero-heading__character", style: { animationDelay: `${index * 45}ms` }, children: character }, `${verb}-${index}`))) }, verb), "?"] })] }));
}
