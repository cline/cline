...
export function SearchCombobox({ ariaLabel, className, disabled = false, emptyText = "No results found.", loading = false, onValueChange, options, placeholder = "Select an option…", portalContainer, searchPlaceholder = "Search…", value, }) {
    ...
    return (_jsxs(Popover.Root, { onOpenChange: (nextOpen) => {
            ...
            if (!nextOpen || !unavailable)
                setOpen(nextOpen);
        }, open: visiblyOpen, children: [_jsx(Popover.Trigger, { asChild: true, children: _jsxs("button", { "aria-busy": loading || undefined, "aria-disabled": unavailable || undefined, "aria-haspopup": "listbox", "aria-label": `${ariaLabel}: ${displayedValue}`, "aria-expanded": visiblyOpen, className: cx("cline-ui-combobox__trigger", className), onClick: (event) => {
                        if (unavailable)
                            event.preventDefault();
                    }, type: "button", children: [loading ? (_jsx("span", { "aria-hidden": "true", className: "cline-ui-spinner" })) : (selected?.icon), _jsx("span", { className: "cline-ui-combobox__value", children: displayedValue }), _jsx("svg", { "aria-hidden": "true", className: "cline-ui-combobox__chevrons", fill: "none", viewBox: "0 0 16 16", children: _jsx("path", { d: "m5 6 3-3 3 3M5 10l3 3 3-3", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.25" }) })] }) }), _jsx(Popover.Portal, { container: portalContainer ?? undefined, children: _jsx(Popover.Content, { align: "start", className: "cline-ui-theme cline-ui-combobox__popover", collisionPadding: 8, sideOffset: 6, children: _jsxs(Command, { className: "cline-ui-combobox__command", label: `Search ${ariaLabel.toLowerCase()}`, onValueChange: setCommandValue, value: commandValue, children: [_jsx(Command.Input, { className: "cline-ui-combobox__search", placeholder: searchPlaceholder }), _jsxs(Command.List, { className: "cline-ui-combobox__list", children: [_jsx(Command.Empty, { className: "cline-ui-combobox__empty", children: emptyText }), options.map((option) => (_jsxs(Command.Item, { className: "cline-ui-combobox__option", keywords: [option.label, option.description ?? ""], onSelect: () => {
