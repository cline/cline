...
export function AgentComposer({ actions, className, disabled, footer, loading = false, onKeyDown, onStop, onSubmit, onValueChange, placeholder = "Describe what you want to build…", running = false, submitDisabled = false, submitLabel = "Send message", value, ...textareaProps }) {
