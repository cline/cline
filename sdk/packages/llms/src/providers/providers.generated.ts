...
export const GENERATED_PROVIDER_SPECS: readonly BuiltinSpec[] = [
	...
	},
	{
		...
		defaultModelId: "abliterated-model-large-v2",
		apiKeyEnv: ["ABLIT_KEY"],
	...
	},
	{
		id: "above",
		name: "above.dev",
		description: "above.dev model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning", "prompt-cache"],
	...
	},
	{
		id: "agentrouter",
		name: "AgentRouter",
		description: "AgentRouter model provider from models.dev",
		family: "openai-compatible",
	...
	},
	{
		id: "amd",
		name: "AMD",
		description: "AMD model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning", "prompt-cache"],
	...
	},
	{
		id: "arcee",
		name: "Arcee",
		description: "Arcee model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning", "prompt-cache"],
		modelsProviderId: "arcee",
	...
	},
	{
		id: "bothub",
		name: "Bothub",
		description: "Bothub model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
	...
	},
	{
		...
		defaultModelId: "Qwen/Qwen3.8-27B-TEE",
	...
	},
	{
		...
		defaultModelId: "@cf/zai-org/glm-5.3-flash",
	...
	},
	{
		id: "echo",
		name: "Echo",
		description: "Echo model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
		modelsProviderId: "echo",
		defaultModelId: "echo",
		apiKeyEnv: ["ECHO_API_KEY"],
		docsUrl: "https://echo.tracerml.ai/docs/api",
		defaults: {
	...
	},
	{
		id: "jalapeno",
		name: "Jalapeno Cloud",
		description: "Jalapeno Cloud model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
		modelsProviderId: "jalapeno",
		defaultModelId: "Kimi-K3",
		apiKeyEnv: ["JALAPENO_API_KEY"],
		docsUrl: "https://www.jalapeno-cloud.ai/docs/",
		defaults: {
	...
	},
	{
		...
		description: "klokintegration.se model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools"],
		modelsProviderId: "klokintegration",
		defaultModelId: "Kloker",
		apiKeyEnv: ["KLOKINTEGRATION_API_KEY"],
		docsUrl: "https://klokintegration.se/docs/ai-api",
		defaults: {
	...
	},
	{
		id: "kosmik",
		name: "Kosmik Compute",
		description: "Kosmik Compute model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning", "prompt-cache"],
		modelsProviderId: "kosmik",
		defaultModelId: "qwen/qwen3.8-27b",
		apiKeyEnv: ["KOSMIK_API_KEY"],
		docsUrl: "https://api.koscompute.com/docs/",
		defaults: {
	...
	},
	{
		...
		description: "DevPass (LLM Gateway) model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning", "prompt-cache"],
	...
	},
	{
		...
		defaultModelId: "muse-glimmer-30b-tr",
	...
	},
	{
		id: "openreason",
		name: "OpenReason",
		description: "OpenReason model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
		modelsProviderId: "openreason",
		defaultModelId: "deepseek-ai/deepseek-v4-flash-0731",
		apiKeyEnv: ["OPENREASON_API_KEY"],
		docsUrl: "https://openreason.app/docs",
		defaults: {
	...
	},
	{
		id: "opper",
		name: "Opper",
		description: "Opper model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning", "prompt-cache"],
	...
	},
	{
		...
		defaultModelId: "orcarouter/free",
	...
	},
	{
		id: "runinfra",
		name: "RunInfra",
		description: "RunInfra model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning", "prompt-cache"],
		modelsProviderId: "runinfra",
		defaultModelId: "zai-org/GLM-5.3-Flash",
		apiKeyEnv: ["RUNINFRA_GATEWAY_KEY"],
		docsUrl: "https://runinfra.ai/docs",
		defaults: {
	...
	},
	{
		...
		description: "SCNet Token Plan model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
	...
	},
	{
		...
		description: "SenseNova (China) model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
	...
	},
	{
		id: "tokengo",
		name: "TokenGo",
		description: "TokenGo model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning", "prompt-cache"],
		modelsProviderId: "tokengo",
		defaultModelId: "z-ai/glm-5.3-flash",
		apiKeyEnv: ["TOKENGO_API_KEY"],
		docsUrl: "https://www.tokengo.com/docs",
		defaults: {
	...
	},
	{
		id: "tokenrouter",
		name: "TokenRouter",
		description: "TokenRouter model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
		modelsProviderId: "tokenrouter",
		defaultModelId: "z-ai/glm-5.3-free",
		apiKeyEnv: ["TOKENROUTER_API_KEY"],
		docsUrl: "https://www.tokenrouter.com/docs/tokenrouter-feature-guide/",
		defaults: {
	...
	},
	{
		...
		defaultModelId: "trustedrouter/synth",
	...
	},
	{
		id: "vancine",
		name: "Vancine",
		description: "Vancine model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning", "prompt-cache"],
	...
	},
	{
		id: "volcengine",
		name: "Volcengine Ark",
		description: "Volcengine Ark model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning", "prompt-cache"],
	...
	},
	{
		...
		description: "Volcengine Ark Coding Plan model provider from models.dev",
		family: "openai-compatible",
		capabilities: ["tools", "reasoning"],
