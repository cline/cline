...
function buildTokenLabModels(): Record<string, ModelInfo> {
	const models: ModelInfo[] = [
		...
		},
		{
			...
			maxInputTokens: 400_000,
			maxTokens: 128_000,
			capabilities: ["images", "tools", "prompt-cache", "temperature"],
			pricing: { input: 0.225, output: 1.35, cacheRead: 0.0225 },
			family: "gpt",
		},
		{
			id: "claude-sonnet-5",
		...
		},
		{
			...
			pricing: { input: 0.125, output: 0.75, cacheRead: 0.0125 },
		...
		},
		{
			...
			pricing: { input: 1.25, output: 2.5, cacheRead: 0.2 },
			family: "grok",
		},
		{
			id: "grok-4-fast",
			...
			pricing: { input: 0.2, output: 0.5, cacheRead: 0.05 },
			family: "grok",
		},
		{
			id: "deepseek-v4-pro",
		...
		},
		{
			...
			maxTokens: 65_536,
			capabilities: ["prompt-cache", "temperature"],
			pricing: {
				input: 1.76470588,
				output: 5.29411764,
				cacheRead: 0.35294117,
				cacheWrite: 2.20588235,
			},
			family: "qwen",
		},
		{
		...
		},
		{
			...
			pricing: { input: 1.9, output: 8, cacheRead: 0.38 },
			family: "kimi",
		},
		{
			id: "minimax-m3",
			...
			maxInputTokens: 1_048_576,
			maxTokens: 524_288,
			capabilities: ["tools", "prompt-cache", "temperature"],
			pricing: { input: 0.3, output: 1.2, cacheRead: 0.06 },
			family: "minimax",
		},
	];
...
const OPENAI_COMPATIBLE_SPECS: BuiltinSpec[] = [
	...
	},
	{
		...
		name: "TokenLab",
		description:
			"Unified AI gateway with OpenAI-compatible chat plus native Responses, Anthropic Messages, Gemini, embeddings, and multimodal endpoints",
		family: "openai-compatible",
		popular: 50,
		capabilities: ["reasoning", "prompt-cache", "tools", "vision"],
		defaultModelId: "gpt-5.5",
		apiKeyEnv: ["TOKENLAB_API_KEY"],
		modelsProviderId: "tokenlab",
		modelsFactory: buildTokenLabModels,
		modelsSourceUrl: "https://api.tokenlab.sh/v1/models",
		docsUrl: "https://docs.tokenlab.sh/introduction",
		defaults: { baseUrl: "https://api.tokenlab.sh/v1" },
	},
	{
		id: "litellm",
		name: "LiteLLM",
