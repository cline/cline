...
export interface HubSettingsToggleInput {
	type: HubSettingsType;
	id?: string;
	path?: string;
	name?: string;
	enabled?: boolean;
...
export interface HubSettingsMutationResult {
	snapshot: Record<string, unknown[]>;
	changedTypes: HubSettingsType[];
}
...
export class HubUIClient {
	...
	async toggleSetting(
		input: HubSettingsToggleInput,
	): Promise<HubSettingsMutationResult> {
		...
		return reply.payload as unknown as HubSettingsMutationResult;
	}
