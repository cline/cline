	...
	return (
		<div
			...
			<div
				...
				aria-label={t("chat:slashMenu.label")}
				...
				{filteredCommands.length > 0 ? (
					<>
						{renderCommandSection(defaultCommands, t("chat:slashMenu.defaultCommands"), 0, true)}
						{renderCommandSection(
							workflowCommands,
							t("chat:slashMenu.workflowCommands"),
							defaultCommands.length,
							false,
						)}
						{renderCommandSection(
							mcpCommands,
							t("chat:slashMenu.mcpPrompts"),
					...
					<div aria-selected="false" className="py-2 px-3 cursor-default flex flex-col" role="option">
						<div className="text-[0.85em] text-(--vscode-descriptionForeground)">
							{t("chat:slashMenu.noMatchingCommands")}
						</div>
					</div>
				)}
			</div>
