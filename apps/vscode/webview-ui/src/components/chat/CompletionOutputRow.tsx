 ...
 * a green-tinted container with a small, muted "Response" label and a copy
 * button. The response might be a question or an interim summary rather than
 * a definitive task completion, so the header deliberately makes no
	...
	return (
		<div className="rounded-sm border border-success/20 overflow-visible bg-success/10">
			<div className="flex items-center justify-between gap-2 pl-2 pr-1 pt-1 -mb-1.5">
				<span className="text-xs font-medium uppercase tracking-wider text-success/70">Response</span>
