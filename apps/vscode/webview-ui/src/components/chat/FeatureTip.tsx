...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have Bedrock Coder verify its work before finishing a task.',
	},
	{
		text: "Add a .bedrock-coder file to your project root to give Bedrock Coder project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before Bedrock Coder takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give Bedrock Coder access to external tools and APIs.",
	},
	{
		text: "Bedrock Coder creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
		text: "Use /compact to condense long conversations and free up context window space.",
	},
	{
		text: "Use the quote button to select text from Bedrock Coder's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with Bedrock Coder.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while BedrockCoder is thinking.
 */
