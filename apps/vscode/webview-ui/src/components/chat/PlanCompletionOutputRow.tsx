 ...
 * toggle and the CLI's plan-mode color) with a small, muted "Plan Response"
 * label and a copy button. The response might be a question rather than a
 * finished plan, so the header deliberately makes no "Plan Created" claim.
 */
	...
	return (
		<div className="rounded-sm border border-warning/20 overflow-visible bg-warning/10">
			<div className="flex items-center justify-between gap-2 pl-2 pr-1 pt-1 -mb-1.5">
				<span className="text-xs font-medium uppercase tracking-wider text-warning/70">Plan Response</span>
