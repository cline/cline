 ...
 */
export function useChatState(messages: BedrockCoderMessage[]): ChatState {
	...
	const bedrockCoderAsk = useMemo(() => (lastMessage?.type === "ask" ? lastMessage.ask : undefined), [lastMessage])
