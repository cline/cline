...
interface MessagesAreaProps {
	task: ClineMessage
	/**
	 * The rows to render, including the synthetic "Thinking..." placeholder row when waiting on
	 * the model (computed by useDisplayedGroupedMessages in ChatView so scroll behavior sees the
	 * same list Virtuoso renders).
	 */
