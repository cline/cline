...
export const LMStudioProvider = ({ currentMode }: LMStudioProviderProps) => {
	...
	return (
		<div className="flex flex-col gap-2">
			...
			<ApiKeyField
				helpText="Optional API key for LM Studio servers that require authentication (Developer → Server Settings → Require Authentication). Leave empty for local instances without auth."
