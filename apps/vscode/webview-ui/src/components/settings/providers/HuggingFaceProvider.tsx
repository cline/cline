	...
	return (
		<div>
			<DebouncedTextField
				...
				style={{ width: "100%" }}
				type="password">
				<span style={{ fontWeight: 500 }}>{t("providers:huggingface.apiKeyLabel")}</span>
			</DebouncedTextField>
			<p
				style={{
					fontSize: "12px",
				...
				{t("providers:shared.apiKeyStoredLocally")} {t("providers:huggingface.pricingNote")}{" "}
				<a href="https://huggingface.co/settings/tokens" rel="noopener noreferrer" target="_blank">
					{t("providers:huggingface.getApiKeyLink")}
				</a>
			</p>
