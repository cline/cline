...
if [ "$#" -ne 3 ]; then
    ...
    echo ""
    echo "Example:"
    echo "  $0 bedrock-coder-3.55.0.vsix bedrock-coder-3.55.0-enterprise.vsix endpoints.json"
    exit 1
fi
...
echo "When installed, BedrockCoder will automatically use the bundled configuration."
