...
function createBaseSearchWorkspaceItemsRequest(): SearchWorkspaceItemsRequest {
  return { query: "", limit: undefined, selectedType: undefined, workspacePath: undefined };
}
...
export const SearchWorkspaceItemsRequest: MessageFns<SearchWorkspaceItemsRequest> = {
  encode(message: SearchWorkspaceItemsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.workspacePath !== undefined) {
      writer.uint32(34).string(message.workspacePath);
    }
    return writer;
  },
...
export const OpenFolderRequest: MessageFns<OpenFolderRequest> = {
  ...
  create<I extends Exact<DeepPartial<OpenFolderRequest>, I>>(base?: I): OpenFolderRequest {
...
export const OpenFolderResponse: MessageFns<OpenFolderResponse> = {
  ...
  create<I extends Exact<DeepPartial<OpenFolderResponse>, I>>(base?: I): OpenFolderResponse {
    return OpenFolderResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OpenFolderResponse>, I>>(object: I): OpenFolderResponse {
    const message = createBaseOpenFolderResponse();
    message.success = object.success ?? false;
    return message;
  },
...
export const WorkspaceServiceDefinition = {
  ...
  methods: {
    ...
    searchWorkspaceItems: {
      name: "searchWorkspaceItems",
      requestType: SearchWorkspaceItemsRequest,
      requestStream: false,
      responseType: SearchWorkspaceItemsResponse,
      responseStream: false,
      options: {},
    },
  },
...
export const WorkspaceServiceService = {
  ...
  openInFileExplorerPanel: {
    ...
    requestDeserialize: (value: Buffer): OpenInFileExplorerPanelRequest => OpenInFileExplorerPanelRequest.decode(value),
  ...
  openClineSidebarPanel: {
    ...
    requestDeserialize: (value: Buffer): OpenClineSidebarPanelRequest => OpenClineSidebarPanelRequest.decode(value),
    ...
    responseDeserialize: (value: Buffer): OpenClineSidebarPanelResponse => OpenClineSidebarPanelResponse.decode(value),
  },
  /** Opens and focuses the terminal panel. */
  openTerminalPanel: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OpenTerminalRequest): Buffer => Buffer.from(OpenTerminalRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): OpenTerminalRequest => OpenTerminalRequest.decode(value),
    responseSerialize: (value: OpenTerminalResponse): Buffer =>
      Buffer.from(OpenTerminalResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): OpenTerminalResponse => OpenTerminalResponse.decode(value),
  },
  /** Executes a command in a new terminal */
  executeCommandInTerminal: {
  ...
  openFolder: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OpenFolderRequest): Buffer => Buffer.from(OpenFolderRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): OpenFolderRequest => OpenFolderRequest.decode(value),
    responseSerialize: (value: OpenFolderResponse): Buffer => Buffer.from(OpenFolderResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): OpenFolderResponse => OpenFolderResponse.decode(value),
  },
  /**
   * Searches workspace files/folders by name using the host's native index
   * (e.g. IntelliJ FilenameIndex). Hosts that lack a fast index should leave
   ...
   */
  searchWorkspaceItems: {
    path: "/host.WorkspaceService/searchWorkspaceItems",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SearchWorkspaceItemsRequest): Buffer =>
      Buffer.from(SearchWorkspaceItemsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): SearchWorkspaceItemsRequest => SearchWorkspaceItemsRequest.decode(value),
    responseSerialize: (value: SearchWorkspaceItemsResponse): Buffer =>
      Buffer.from(SearchWorkspaceItemsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): SearchWorkspaceItemsResponse => SearchWorkspaceItemsResponse.decode(value),
  },
} as const;
...
export interface WorkspaceServiceServer extends UntypedServiceImplementation {
   ...
   * this UNIMPLEMENTED so the caller can fall back to ripgrep.
   */
  searchWorkspaceItems: handleUnaryCall<SearchWorkspaceItemsRequest, SearchWorkspaceItemsResponse>;
}
...
export interface WorkspaceServiceClient extends Client {
  ...
  openFolder(
    ...
    callback: (error: ServiceError | null, response: OpenFolderResponse) => void,
  ): ClientUnaryCall;
  openFolder(
    request: OpenFolderRequest,
    metadata: Metadata,
   ...
   */
  searchWorkspaceItems(
    request: SearchWorkspaceItemsRequest,
    callback: (error: ServiceError | null, response: SearchWorkspaceItemsResponse) => void,
  ): ClientUnaryCall;
  searchWorkspaceItems(
    request: SearchWorkspaceItemsRequest,
    metadata: Metadata,
