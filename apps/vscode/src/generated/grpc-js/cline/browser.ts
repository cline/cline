...
export const BrowserServiceService = {
  getBrowserConnectionInfo: {
    ...
    responseSerialize: (value: BrowserConnectionInfo): Buffer =>
      Buffer.from(BrowserConnectionInfo.encode(value).finish()),
    responseDeserialize: (value: Buffer): BrowserConnectionInfo => BrowserConnectionInfo.decode(value),
  },
  testBrowserConnection: {
    ...
    responseSerialize: (value: BrowserConnection): Buffer => Buffer.from(BrowserConnection.encode(value).finish()),
    responseDeserialize: (value: Buffer): BrowserConnection => BrowserConnection.decode(value),
  },
  discoverBrowser: {
  ...
  getDetectedChromePath: {
    ...
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: ChromePath): Buffer => Buffer.from(ChromePath.encode(value).finish()),
    responseDeserialize: (value: Buffer): ChromePath => ChromePath.decode(value),
  },
  relaunchChromeDebugMode: {
