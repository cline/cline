...
export interface SkillInfo {
  ...
  description: string;
  /** Full path to SKILL.md file (or "remote:<name>" for remote skills) */
  path: string;
  /** Whether the skill is enabled */
  enabled: boolean;
  /** Whether the skill is always enabled (remote only, user cannot toggle off) */
...
export interface SkillsToggles {
  ...
  remoteSkillsToggles: { [key: string]: boolean };
}
...
export interface SkillsToggles_RemoteSkillsTogglesEntry {
  key: string;
  value: boolean;
}
...
function createBaseFileSearchResults(): FileSearchResults {
  return { results: [], mentionsRequestId: undefined, errorReason: undefined, errorMessage: undefined };
}
  ...
  fromJSON(object: any): FileSearchResults {
    return {
      ...
      errorReason: isSet(object.errorReason)
        ? globalThis.String(object.errorReason)
        : isSet(object.error_reason)
        ? globalThis.String(object.error_reason)
        : undefined,
...
function createBaseSkillInfo(): SkillInfo {
  return { name: "", description: "", path: "", enabled: false, alwaysEnabled: false };
}
...
export const SkillInfo: MessageFns<SkillInfo> = {
  encode(message: SkillInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.alwaysEnabled !== false) {
      writer.uint32(40).bool(message.alwaysEnabled);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.alwaysEnabled = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SkillInfo {
    return {
      ...
      path: isSet(object.path) ? globalThis.String(object.path) : "",
      enabled: isSet(object.enabled) ? globalThis.Boolean(object.enabled) : false,
      alwaysEnabled: isSet(object.alwaysEnabled)
        ? globalThis.Boolean(object.alwaysEnabled)
        : isSet(object.always_enabled)
        ? globalThis.Boolean(object.always_enabled)
        : false,
    };
  },
  ...
  toJSON(message: SkillInfo): unknown {
    ...
    if (message.alwaysEnabled !== false) {
      obj.alwaysEnabled = message.alwaysEnabled;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<SkillInfo>, I>>(object: I): SkillInfo {
    ...
    message.path = object.path ?? "";
    message.enabled = object.enabled ?? false;
    message.alwaysEnabled = object.alwaysEnabled ?? false;
    return message;
  },
};
...
function createBaseSkillsToggles(): SkillsToggles {
  return { globalSkillsToggles: {}, localSkillsToggles: {}, remoteSkillsToggles: {} };
}
...
export const SkillsToggles: MessageFns<SkillsToggles> = {
  encode(message: SkillsToggles, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.remoteSkillsToggles).forEach(([key, value]: [string, boolean]) => {
      SkillsToggles_RemoteSkillsTogglesEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).join();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          const entry3 = SkillsToggles_RemoteSkillsTogglesEntry.decode(reader, reader.uint32());
          if (entry3.value !== undefined) {
            message.remoteSkillsToggles[entry3.key] = entry3.value;
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): SkillsToggles {
    return {
      ...
      localSkillsToggles: isObject(object.localSkillsToggles)
        ...
        : {},
      remoteSkillsToggles: isObject(object.remoteSkillsToggles)
        ? (globalThis.Object.entries(object.remoteSkillsToggles) as [string, any][]).reduce(
          (acc: { [key: string]: boolean }, [key, value]: [string, any]) => {
            acc[key] = globalThis.Boolean(value);
            return acc;
          },
        ...
        : isObject(object.remote_skills_toggles)
        ? (globalThis.Object.entries(object.remote_skills_toggles) as [string, any][]).reduce(
          (acc: { [key: string]: boolean }, [key, value]: [string, any]) => {
            acc[key] = globalThis.Boolean(value);
            return acc;
          },
  ...
  toJSON(message: SkillsToggles): unknown {
    ...
    if (message.remoteSkillsToggles) {
      const entries = globalThis.Object.entries(message.remoteSkillsToggles) as [string, boolean][];
      if (entries.length > 0) {
        obj.remoteSkillsToggles = {};
        entries.forEach(([k, v]) => {
          obj.remoteSkillsToggles[k] = v;
        });
      }
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<SkillsToggles>, I>>(object: I): SkillsToggles {
    ...
    message.remoteSkillsToggles = (globalThis.Object.entries(object.remoteSkillsToggles ?? {}) as [string, boolean][])
      .reduce((acc: { [key: string]: boolean }, [key, value]: [string, boolean]) => {
        if (value !== undefined) {
          acc[key] = globalThis.Boolean(value);
        }
...
function createBaseSkillsToggles_RemoteSkillsTogglesEntry(): SkillsToggles_RemoteSkillsTogglesEntry {
  return { key: "", value: false };
}

export const SkillsToggles_RemoteSkillsTogglesEntry: MessageFns<SkillsToggles_RemoteSkillsTogglesEntry> = {
  encode(message: SkillsToggles_RemoteSkillsTogglesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SkillsToggles_RemoteSkillsTogglesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSkillsToggles_RemoteSkillsTogglesEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): SkillsToggles_RemoteSkillsTogglesEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.Boolean(object.value) : false,
    };
  ...
  toJSON(message: SkillsToggles_RemoteSkillsTogglesEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<SkillsToggles_RemoteSkillsTogglesEntry>, I>>(
    base?: I,
  ): SkillsToggles_RemoteSkillsTogglesEntry {
    return SkillsToggles_RemoteSkillsTogglesEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SkillsToggles_RemoteSkillsTogglesEntry>, I>>(
    object: I,
  ): SkillsToggles_RemoteSkillsTogglesEntry {
    const message = createBaseSkillsToggles_RemoteSkillsTogglesEntry();
    message.key = object.key ?? "";
...
export const FileServiceService = {
  ...
  deleteRuleFile: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RuleFileRequest): Buffer => Buffer.from(RuleFileRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): RuleFileRequest => RuleFileRequest.decode(value),
    responseSerialize: (value: RuleFile): Buffer => Buffer.from(RuleFile.encode(value).finish()),
    responseDeserialize: (value: Buffer): RuleFile => RuleFile.decode(value),
  },
  /** Creates a rule file from either global or workspace rules directory */
  createRuleFile: {
  ...
  searchCommits: {
    ...
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
    responseSerialize: (value: GitCommits): Buffer => Buffer.from(GitCommits.encode(value).finish()),
    responseDeserialize: (value: Buffer): GitCommits => GitCommits.decode(value),
  },
  /** Select images and other files from the file system and returns as data URLs & paths respectively */
  selectFiles: {
    ...
    responseSerialize: (value: StringArrays): Buffer => Buffer.from(StringArrays.encode(value).finish()),
    responseDeserialize: (value: Buffer): StringArrays => StringArrays.decode(value),
  },
  /** Convert URIs to workspace-relative paths */
  getRelativePaths: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RelativePathsRequest): Buffer => Buffer.from(RelativePathsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): RelativePathsRequest => RelativePathsRequest.decode(value),
    responseSerialize: (value: RelativePaths): Buffer => Buffer.from(RelativePaths.encode(value).finish()),
    responseDeserialize: (value: Buffer): RelativePaths => RelativePaths.decode(value),
  },
  /** Search for files in the workspace with fuzzy matching */
  searchFiles: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: FileSearchRequest): Buffer => Buffer.from(FileSearchRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): FileSearchRequest => FileSearchRequest.decode(value),
    responseSerialize: (value: FileSearchResults): Buffer => Buffer.from(FileSearchResults.encode(value).finish()),
    responseDeserialize: (value: Buffer): FileSearchResults => FileSearchResults.decode(value),
  },
  /** Toggle a Cline rule (enable or disable) */
  toggleClineRule: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleClineRuleRequest): Buffer =>
      Buffer.from(ToggleClineRuleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ToggleClineRuleRequest => ToggleClineRuleRequest.decode(value),
    responseSerialize: (value: ToggleClineRules): Buffer => Buffer.from(ToggleClineRules.encode(value).finish()),
    responseDeserialize: (value: Buffer): ToggleClineRules => ToggleClineRules.decode(value),
  },
  /** Toggle a Cursor rule (enable or disable) */
  toggleCursorRule: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleCursorRuleRequest): Buffer =>
      Buffer.from(ToggleCursorRuleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ToggleCursorRuleRequest => ToggleCursorRuleRequest.decode(value),
    responseSerialize: (value: ClineRulesToggles): Buffer => Buffer.from(ClineRulesToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer): ClineRulesToggles => ClineRulesToggles.decode(value),
  },
  /** Toggle a Windsurf rule (enable or disable) */
  toggleWindsurfRule: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleWindsurfRuleRequest): Buffer =>
      Buffer.from(ToggleWindsurfRuleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ToggleWindsurfRuleRequest => ToggleWindsurfRuleRequest.decode(value),
    responseSerialize: (value: ClineRulesToggles): Buffer => Buffer.from(ClineRulesToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer): ClineRulesToggles => ClineRulesToggles.decode(value),
  },
  /** Toggle an Agents rule (enable or disable) */
  toggleAgentsRule: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleAgentsRuleRequest): Buffer =>
      Buffer.from(ToggleAgentsRuleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ToggleAgentsRuleRequest => ToggleAgentsRuleRequest.decode(value),
    responseSerialize: (value: ClineRulesToggles): Buffer => Buffer.from(ClineRulesToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer): ClineRulesToggles => ClineRulesToggles.decode(value),
  },
  /** Refreshes all rule toggles (Cline, External, and Workflows) */
  refreshRules: {
    ...
    responseSerialize: (value: RefreshedRules): Buffer => Buffer.from(RefreshedRules.encode(value).finish()),
    responseDeserialize: (value: Buffer): RefreshedRules => RefreshedRules.decode(value),
  },
  /** Opens a task's conversation history file on disk */
  openDiskConversationHistory: {
  ...
  toggleWorkflow: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleWorkflowRequest): Buffer =>
      Buffer.from(ToggleWorkflowRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ToggleWorkflowRequest => ToggleWorkflowRequest.decode(value),
    responseSerialize: (value: ClineRulesToggles): Buffer => Buffer.from(ClineRulesToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer): ClineRulesToggles => ClineRulesToggles.decode(value),
  },
  /** Check if file exists in the project */
  ifFileExistsRelativePath: {
    ...
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
    responseSerialize: (value: BooleanResponse): Buffer => Buffer.from(BooleanResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): BooleanResponse => BooleanResponse.decode(value),
  },
  /** Open a file in editor by a relative path */
  openFileRelativePath: {
  ...
  refreshHooks: {
    ...
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: HooksToggles): Buffer => Buffer.from(HooksToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer): HooksToggles => HooksToggles.decode(value),
  },
  /** Toggles a hook on or off via chmod +x/-x */
  toggleHook: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleHookRequest): Buffer => Buffer.from(ToggleHookRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ToggleHookRequest => ToggleHookRequest.decode(value),
    responseSerialize: (value: ToggleHookResponse): Buffer => Buffer.from(ToggleHookResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): ToggleHookResponse => ToggleHookResponse.decode(value),
  },
  /** Creates a new hook from template */
  createHook: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateHookRequest): Buffer => Buffer.from(CreateHookRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): CreateHookRequest => CreateHookRequest.decode(value),
    responseSerialize: (value: CreateHookResponse): Buffer => Buffer.from(CreateHookResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): CreateHookResponse => CreateHookResponse.decode(value),
  },
  /** Deletes an existing hook file */
  deleteHook: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteHookRequest): Buffer => Buffer.from(DeleteHookRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): DeleteHookRequest => DeleteHookRequest.decode(value),
    responseSerialize: (value: DeleteHookResponse): Buffer => Buffer.from(DeleteHookResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): DeleteHookResponse => DeleteHookResponse.decode(value),
  },
  /** Refreshes all skill toggles (discovers skills and their enabled state) */
  refreshSkills: {
    ...
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: RefreshedSkills): Buffer => Buffer.from(RefreshedSkills.encode(value).finish()),
    responseDeserialize: (value: Buffer): RefreshedSkills => RefreshedSkills.decode(value),
  },
  /** Toggles a skill on or off */
  toggleSkill: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleSkillRequest): Buffer => Buffer.from(ToggleSkillRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): ToggleSkillRequest => ToggleSkillRequest.decode(value),
    responseSerialize: (value: SkillsToggles): Buffer => Buffer.from(SkillsToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer): SkillsToggles => SkillsToggles.decode(value),
  },
  /** Creates a new skill from template */
  createSkillFile: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateSkillRequest): Buffer => Buffer.from(CreateSkillRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): CreateSkillRequest => CreateSkillRequest.decode(value),
    responseSerialize: (value: SkillsToggles): Buffer => Buffer.from(SkillsToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer): SkillsToggles => SkillsToggles.decode(value),
  },
  /** Deletes an existing skill directory */
  deleteSkillFile: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteSkillRequest): Buffer => Buffer.from(DeleteSkillRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): DeleteSkillRequest => DeleteSkillRequest.decode(value),
    responseSerialize: (value: SkillsToggles): Buffer => Buffer.from(SkillsToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer): SkillsToggles => SkillsToggles.decode(value),
  },
} as const;
