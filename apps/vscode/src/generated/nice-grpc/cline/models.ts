...
export const ClineRecommendedModel: MessageFns<ClineRecommendedModel> = {
  ...
  create(base?: DeepPartial<ClineRecommendedModel>): ClineRecommendedModel {
    return ClineRecommendedModel.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineRecommendedModel>): ClineRecommendedModel {
    const message = createBaseClineRecommendedModel();
...
export const ClineRecommendedModelsResponse: MessageFns<ClineRecommendedModelsResponse> = {
  ...
  create(base?: DeepPartial<ClineRecommendedModelsResponse>): ClineRecommendedModelsResponse {
    return ClineRecommendedModelsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineRecommendedModelsResponse>): ClineRecommendedModelsResponse {
    const message = createBaseClineRecommendedModelsResponse();
...
export interface ModelsServiceImplementation<CallContextExt = {}> {
  ...
  refreshClineRecommendedModelsRpc(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ClineRecommendedModelsResponse>>;
  /** Refreshes and returns Cline provider models */
  refreshClineModelsRpc(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
