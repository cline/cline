...
export const SkillsToggles_RemoteSkillsTogglesEntry: MessageFns<SkillsToggles_RemoteSkillsTogglesEntry> = {
  ...
  create(base?: DeepPartial<SkillsToggles_RemoteSkillsTogglesEntry>): SkillsToggles_RemoteSkillsTogglesEntry {
    return SkillsToggles_RemoteSkillsTogglesEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SkillsToggles_RemoteSkillsTogglesEntry>): SkillsToggles_RemoteSkillsTogglesEntry {
    const message = createBaseSkillsToggles_RemoteSkillsTogglesEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? false;
    return message;
