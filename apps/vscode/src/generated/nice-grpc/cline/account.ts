...
export interface SubmitLimitIncreaseResponse {
  success: boolean;
}
...
function createBaseSubmitLimitIncreaseResponse(): SubmitLimitIncreaseResponse {
  return { success: false };
}

export const SubmitLimitIncreaseResponse: MessageFns<SubmitLimitIncreaseResponse> = {
  encode(message: SubmitLimitIncreaseResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SubmitLimitIncreaseResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSubmitLimitIncreaseResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): SubmitLimitIncreaseResponse {
    return { success: isSet(object.success) ? globalThis.Boolean(object.success) : false };
  },

  toJSON(message: SubmitLimitIncreaseResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
  ...
  create(base?: DeepPartial<SubmitLimitIncreaseResponse>): SubmitLimitIncreaseResponse {
    return SubmitLimitIncreaseResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SubmitLimitIncreaseResponse>): SubmitLimitIncreaseResponse {
    const message = createBaseSubmitLimitIncreaseResponse();
...
export const AccountServiceDefinition = {
  ...
  methods: {
    ...
    submitLimitIncreaseRequest: {
      name: "submitLimitIncreaseRequest",
      requestType: EmptyRequest,
      requestStream: false,
      responseType: SubmitLimitIncreaseResponse,
      responseStream: false,
      options: {},
    },
  },
...
export interface AccountServiceImplementation<CallContextExt = {}> {
   ...
   * Starts the OAuth flow and opens browser for user to sign in with ChatGPT Plus/Pro
   */
  openAiCodexSignIn(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Signs out of OpenAI Codex and clears stored credentials */
  openAiCodexSignOut(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /**
   * Submits a spend limit increase request to the user's org admin.
   * Called when the user hits a SPEND_LIMIT_EXCEEDED (429) error and clicks "Request Increase".
   */
  submitLimitIncreaseRequest(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<SubmitLimitIncreaseResponse>>;
}
...
export interface AccountServiceClient<CallOptionsExt = {}> {
   ...
   * Starts the OAuth flow and opens browser for user to sign in with ChatGPT Plus/Pro
   */
  openAiCodexSignIn(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Signs out of OpenAI Codex and clears stored credentials */
  openAiCodexSignOut(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /**
   * Submits a spend limit increase request to the user's org admin.
   * Called when the user hits a SPEND_LIMIT_EXCEEDED (429) error and clicks "Request Increase".
   */
