...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		planModeOpenAiBaseUrl: config.planModeOpenAiBaseUrl,
		...
		actModeOpenAiBaseUrl: config.actModeOpenAiBaseUrl,
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		planModeOpenAiBaseUrl: protoConfig.planModeOpenAiBaseUrl,
		...
		actModeOpenAiBaseUrl: protoConfig.actModeOpenAiBaseUrl,
