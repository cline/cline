...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		atomicChatBaseUrl: config.atomicChatBaseUrl,
		atomicChatApiKey: config.atomicChatApiKey,
		...
		planModeAtomicChatModelId: config.planModeAtomicChatModelId,
		...
		actModeAtomicChatModelId: config.actModeAtomicChatModelId,
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		atomicChatBaseUrl: protoConfig.atomicChatBaseUrl,
		atomicChatApiKey: protoConfig.atomicChatApiKey,
		...
		planModeAtomicChatModelId: protoConfig.planModeAtomicChatModelId,
		...
		actModeAtomicChatModelId: protoConfig.actModeAtomicChatModelId,
