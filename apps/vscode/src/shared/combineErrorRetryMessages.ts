 ...
 * @returns A new array of BedrockCoderMessage objects with error_retry sequences consolidated.
 *
 * @example
 ...
 */
export function combineErrorRetryMessages(messages: BedrockCoderMessage[]): BedrockCoderMessage[] {
