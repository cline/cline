...
export const SubmitLimitIncreaseResponse: MessageFns<SubmitLimitIncreaseResponse> = {
  ...
  create<I extends Exact<DeepPartial<SubmitLimitIncreaseResponse>, I>>(base?: I): SubmitLimitIncreaseResponse {
    return SubmitLimitIncreaseResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubmitLimitIncreaseResponse>, I>>(object: I): SubmitLimitIncreaseResponse {
    const message = createBaseSubmitLimitIncreaseResponse();
