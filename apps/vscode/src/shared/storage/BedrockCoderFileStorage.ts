...
import { BedrockCoderSyncStorage } from "./BedrockCoderStorage"

export interface BedrockCoderFileStorageOptions {
	/**
 ...
 */
export class BedrockCoderFileStorage<T = any> extends BedrockCoderSyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "BedrockCoderFileStorage", options?: BedrockCoderFileStorageOptions) {
		super()
