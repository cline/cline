...
import type { ModelsDevProviderModels } from "@shared/models/models-dev-catalog";
	...
	*/
	...
	async handleAuthCallback(
		...
		try {
			...
			const planProvider: ApiProvider =
				currentApiConfiguration.planModeApiProvider === "cline-pass"
					? "cline-pass"
					: "cline";
			const actProvider: ApiProvider =
				currentApiConfiguration.actModeApiProvider === "cline-pass"
					? "cline-pass"
					: "cline";
	...
	async getStateToPostToWebview(): Promise<ExtensionState> {
		...
		return {
			...
			modelsDevProviderModels: this.modelsDevProviderModels,
		};
	}
