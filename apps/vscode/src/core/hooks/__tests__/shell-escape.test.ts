...
describe("Shell Path Escaping", () => {
	...
	describe("Unix/Linux/macOS path escaping", () => {
		...
		it("should handle paths without special characters", () => {
			const path = "/Users/user/.bedrock-coder/Hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/user/.bedrock-coder/Hooks/PreToolUse'")
		})
		...
		it("should handle global hooks directory with spaces", () => {
			const path = "/Users/user name/.bedrock-coder/Hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/user name/.bedrock-coder/Hooks/PreToolUse'")
		})

		it("should handle workspace hooks with spaces in root", () => {
			const path = "/Users/user/My Example Project/.bedrock-coder/hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/user/My Example Project/.bedrock-coder/hooks/PreToolUse'")
		})
	...
	describe("Windows path escaping", () => {
		...
		it("should handle paths without special characters", () => {
			const path = "C:\\Users\\user\\Documents\\BedrockCoder\\Hooks\\PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal('"C:\\Users\\user\\Documents\\BedrockCoder\\Hooks\\PreToolUse"')
		})
		...
		it("should handle global hooks directory with spaces", () => {
			const path = "C:\\Users\\user name\\Documents\\BedrockCoder\\Hooks\\PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal('"C:\\Users\\user name\\Documents\\BedrockCoder\\Hooks\\PreToolUse"')
		})

		it("should handle workspace hooks with spaces in root", () => {
			const path = "C:\\Users\\user\\My Example Project\\.bedrock-coder\\hooks\\PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal('"C:\\Users\\user\\My Example Project\\.bedrock-coder\\hooks\\PreToolUse"')
		})
	...
	describe("Real-world scenarios", () => {
		it("should handle typical macOS global hooks path with space in username", () => {
			setPlatform("darwin")
			const path = "/Users/John Doe/.bedrock-coder/Hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/John Doe/.bedrock-coder/Hooks/PreToolUse'")
		})

		it("should handle typical Windows global hooks path with space in username", () => {
			setPlatform("win32")
			const path = "C:\\Users\\John Doe\\Documents\\BedrockCoder\\Hooks\\PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal('"C:\\Users\\John Doe\\Documents\\BedrockCoder\\Hooks\\PreToolUse"')
		})

		it("should handle workspace with company name and spaces", () => {
			setPlatform("darwin")
			const path = "/Users/user/Projects/ACME Corp Project/.bedrock-coder/hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/user/Projects/ACME Corp Project/.bedrock-coder/hooks/PreToolUse'")
		})

		it("should handle workspace with version numbers and spaces", () => {
			setPlatform("darwin")
			const path = "/Users/user/Projects/My Project v2.0/.bedrock-coder/hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/user/Projects/My Project v2.0/.bedrock-coder/hooks/PreToolUse'")
		})

		it("should handle workspace with mixed special characters", () => {
			setPlatform("darwin")
			const path = "/Users/user/Projects/Test's (New) Project v2.0/.bedrock-coder/hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/user/Projects/Test'\\''s (New) Project v2.0/.bedrock-coder/hooks/PreToolUse'")
		})
	})
	...
	describe("Multi-root workspace scenarios", () => {
		it("should handle multiple roots with spaces (macOS)", () => {
			setPlatform("darwin")
			const roots = [
				"/Users/user/My Frontend Project/.bedrock-coder/hooks/PreToolUse",
				"/Users/user/My Backend Project/.bedrock-coder/hooks/PreToolUse",
				"/Users/user/Shared Utils/.bedrock-coder/hooks/PreToolUse",
			]
		...
		it("should handle multiple roots with spaces (Windows)", () => {
			setPlatform("win32")
			const roots = [
				"C:\\Users\\user\\My Frontend Project\\.bedrock-coder\\hooks\\PreToolUse",
				"C:\\Users\\user\\My Backend Project\\.bedrock-coder\\hooks\\PreToolUse",
				"C:\\Users\\user\\Shared Utils\\.bedrock-coder\\hooks\\PreToolUse",
			]
