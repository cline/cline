...
/** Release the agent turn if a foreground command is still running after 30 seconds. */
export const FOREGROUND_COMMAND_AUTO_PROCEED_MS = 30 * 1000
...
export async function executeForeground(
	...
	// detach this command. If they do not act, automatically detach after 30
