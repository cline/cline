...
import type { BedrockCoderAPI } from "../exports/bedrock-coder"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("Bedrock CoderAPI Core Functionality", () => {
	let api: BedrockCoderAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createBedrockCoderAPI expects
		...
		// Create API instance
		api = createBedrockCoderAPI(mockController)
	})
