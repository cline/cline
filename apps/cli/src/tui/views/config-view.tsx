			...
			case "toggle":
				switch (row.id) {
					case "mode": {
						...
						setMode(nextMode);
						setCliTuiSettings({ mode: nextMode });
						props.onToggleMode();
						break;
					}
					case "auto-approve": {
						...
						setCliTuiSettings({ autoApproveAll: nextAutoApprove });
					...
					case "compaction": {
						...
						setCliTuiSettings({ compactionMode: nextMode });
					...
					case "verbose": {
						...
						setCliTuiSettings({ verbose: nextVerbose });
						break;
					}
				}
				break;
