	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					"relative w-(--sidebar-width) bg-transparent transition-[width] duration-60 ease-in-out",
			...
			<div
				...
				className={cn(
					"fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-60 ease-in-out md:flex",
					side === "left"
