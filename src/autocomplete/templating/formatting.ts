...
const formatClipboardSnippet = (snippet: AutocompleteClipboardSnippet, workspaceDirs: string[]): AutocompleteCodeSnippet => {
...
export const formatSnippets = (helper: HelperVars, snippets: AutocompleteSnippet[], workspaceDirs: string[]): string => {
	const currentFilepathComment = addCommentMarks(getLastNUriRelativePathParts(workspaceDirs, helper.filepath, 2), helper)
