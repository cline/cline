...
export async function ensureTaskDirectoryExists(taskId: string): Promise<string> {
	return HostProvider.ensureGlobalStorageDirExists("tasks", taskId)
}
...
export async function ensureSettingsDirectoryExists(): Promise<string> {
	return HostProvider.ensureGlobalStorageDirExists("settings")
}
...
export async function ensureStateDirectoryExists(): Promise<string> {
	return HostProvider.ensureGlobalStorageDirExists("state")
}

export async function ensureCacheDirectoryExists(): Promise<string> {
	return HostProvider.ensureGlobalStorageDirExists("cache")
}
