...
/**
 * Handles the installation of the Beadsmith CLI tool
 * @param controller The controller instance
 * @param _request The empty request
 * @returns Empty response
 */
export async function installBeadsmithCli(_controller: Controller, _request: EmptyRequest): Promise<Empty> {
