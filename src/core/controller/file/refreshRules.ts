import { refreshBeadsmithRulesToggles } from "@core/context/instructions/user-instructions/beadsmith-rules"
import { refreshExternalRulesToggles } from "@core/context/instructions/user-instructions/external-rules"
import { refreshWorkflowToggles } from "@core/context/instructions/user-instructions/workflows"
import { EmptyRequest } from "@shared/proto/beadsmith/common"
import { RefreshedRules } from "@shared/proto/beadsmith/file"
import { Logger } from "@/shared/services/Logger"
import { getCwd, getDesktopDir } from "@/utils/path"
import type { Controller } from "../index"

/**
 * Refreshes all rule toggles (Beadsmith, External, and Workflows)
...
export async function refreshRules(controller: Controller, _request: EmptyRequest): Promise<RefreshedRules> {
	try {
		...
		const { globalToggles, localToggles } = await refreshBeadsmithRulesToggles(controller, cwd)
