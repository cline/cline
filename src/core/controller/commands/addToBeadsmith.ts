...
// 'Add to Beadsmith' context menu in editor and code action
// Inserts the selected code into the chat.
export async function addToBeadsmith(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToBeadsmith", request.selectedText, filePath, request.language)
