 ...
 * @param request The request containing the API Key
 * @returns Response containing the OpenRouter models
 */
export async function refreshHicapModelsCli(
	...
	try {
		// Get the Hicap API key from Cline CLI user input for API Key
		const hicapApiKey = _request.value
