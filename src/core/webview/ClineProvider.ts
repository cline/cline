...
export class ClineProvider implements vscode.WebviewViewProvider {
	...
	*/
	...
	private getHtmlContent(webview: vscode.Webview): string {
		...
		const stylesUri = getUri(webview, this.context.extensionUri, ["webview-ui", "build", "static", "main.css"])
		// The JS file from the React build output
		const scriptUri = getUri(webview, this.context.extensionUri, ["webview-ui", "build", "static", "main.js"])
