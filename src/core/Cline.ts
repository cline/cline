...
export class Cline {
		...
		if (!didWorkspaceRestoreFail) {
			switch (restoreType) {
				...
				case "taskAndWorkspace":
					...
					await saveApiConversationHistory(this.providerRef, this.taskId, this.apiConversationHistory)
	...
	private async resumeTaskFromHistory() {
		...
		const modifiedClineMessages = await getSavedClineMessages(this.providerRef, this.taskId)
		...
		this.apiConversationHistory = await getSavedApiConversationHistory(this.providerRef, this.taskId)
