...
function normalizeInvocation(value: unknown): SkillMetadata["invocation"] {
	...
	const manual = typeof obj.manual === "boolean" ? obj.manual : undefined
	const auto = typeof obj.auto === "boolean" ? obj.auto : undefined
...
function normalizeSkillMetadata(
	...
	const invocation = normalizeInvocation(frontmatter.invocation)
