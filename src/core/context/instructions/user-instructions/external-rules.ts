...
export async function refreshExternalRulesToggles(
	...
	const localAgentsToggles = controller.cacheService.getWorkspaceStateKey("localAgentsRulesToggles")
	...
	controller.cacheService.setWorkspaceState("localAgentsRulesToggles", updatedLocalAgentsToggles)
