...
export class AwsBedrockHandler implements ApiHandler {
	 ...
	 */
	public mapClineToolsToBedrockToolConfig(tools?: ClineTool[]): ToolConfiguration | undefined {
	 ...
	 */
	public formatMessagesForConverseAPI(messages: ClineStorageMessage[]): Message[] {
	...
	public async *executeConverseStreamForTesting(command: ConverseStreamCommand, modelInfo: ModelInfo): ApiStream {
		yield* this.executeConverseStream(command, modelInfo)
	}

	public async getBedrockClientForTesting() {
