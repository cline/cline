...
/**
 * Converts an array of BeadsmithStorageMessage objects (extension of Anthropic format) to a ResponseInput array to use with OpenAI's Responses API.
 *
 ...
 *
 * @param messages - Array of BeadsmithStorageMessage objects to be converted
 * @returns ResponseInput array containing the transformed messages with proper reasoning pairing
 */
export function convertToOpenAIResponsesInput(messages: BeadsmithStorageMessage[]): ResponseInput {
	const allItems: any[] = []
