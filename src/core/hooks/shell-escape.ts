 ...
 *
 * Use cases:
 * - Global hooks directory: ~/Documents/Beadsmith/Hooks/
 * - Workspace hooks: /path/to/My Project/.beadsmithrules/hooks/
 * - Multi-root workspaces: each root's .beadsmithrules/hooks/
 *
 * Examples:
