...
- After using write_to_file, if you need to make further edits to the same file, you do NOT need to re-read the file as you already have its up-to-date contents.
