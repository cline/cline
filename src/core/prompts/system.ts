...
IMPORTANT NOTE: This tool CANNOT be used until you've confirmed from the user that any previous tool uses were successful. Failure to do so will result in code corruption and system failure. Before using this tool, you must ask yourself in <thinking></thinking> tags if you've confirmed from the user that any previous tool uses were successful. If not, then DO NOT use this tool.if child task is mentioned in this task context, You should use view_pending_tasks to view the child tasks status and make sure all child tasks are completed before using this tool.
Parameters:
