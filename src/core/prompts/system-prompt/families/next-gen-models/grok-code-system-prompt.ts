...
// Adapted from `next-gen-system-prompt.ts`.
// Remove the tool use format and descriptions sections. They are handled by native tool calls.
// Update the tool call format.
// Remove <thinking> tags related instructions.
export const SYSTEM_PROMPT_GROK_CODE = async (
	cwd: string,
...
<parameter name="path">src/frontend-config.json</parameter>
...
<xai:function_call name="new_task">
...
<parameter name="path">src/components/App.tsx</parameter>
<parameter name="diff">
------- SEARCH
...
<xai:function_call name="use_mcp_tool">
...
<xai:function_call name="use_mcp_tool">
<parameter name="server_name">github.com/modelcontextprotocol/servers/tree/main/src/github</parameter>
<parameter name="tool_name">create_issue</parameter>
<parameter name="arguments">
{
  "owner": "octocat",
  "repo": "hello-world",
...
1. During your thinking, assess what information you already have and what information you need to proceed with the task.
...
4. Formulate your tool use using the XML-like format specified for each tool.
...
Example:
<xai:function_call name="execute_command">
<parameter name="command">npm install react</parameter>
<parameter name="requires_approval">false</parameter>
<parameter name="task_progress">
- [x] Set up project structure
- [x] Install dependencies
