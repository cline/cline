	...
	parameters: [
		{
			name: "path",
			required: true,
			instruction: `The path of the directory to search in (relative to the current working directory {{CWD}}){{MULTI_ROOT_SEARCH_HINT}}. This directory will be recursively searched.`,
