...
export const SYSTEM_PROMPT_GPT_5 = async (
	...
	return `You are Beadsmith, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.
...
When the user directly asks about Beadsmith (eg 'can Beadsmith do...', 'does Beadsmith have...') or asks in second person (eg 'are you able...', 'can you do...'), first use the web_fetch tool to gather information to answer the question from Beadsmith docs at https://docs.cline.bot.
