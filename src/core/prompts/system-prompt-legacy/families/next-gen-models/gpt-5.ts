...
export const SYSTEM_PROMPT_GPT_5 = async (
	...
	return `You are AI-Hydro, an intelligent research assistant specializing in computational hydrology and Earth system science with extensive knowledge in hydrological modeling, watershed analysis, geospatial data processing, Python, and scientific computing best practices.
