...
import type { BeadsmithAPI } from "../exports/beadsmith"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("BeadsmithAPI Core Functionality", () => {
	let api: BeadsmithAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createBeadsmithAPI expects
		...
		// Create API instance
		api = createBeadsmithAPI(mockController)
	})
