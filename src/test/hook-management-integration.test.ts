...
import { CreateHookRequest, DeleteHookRequest, ToggleHookRequest } from "../shared/proto/beadsmith/file"
...
describe("Hook Management Integration", () => {
	...
	beforeEach(async () => {
		...
		workspaceHooksDir = path.join(tempDir, "workspace", ".beadsmithrules", "hooks")
