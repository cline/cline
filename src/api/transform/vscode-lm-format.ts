...
function asObjectSafe(value: any): object {
	...
	try {
		...
		console.warn("OG Assistant <Language Model API>: Failed to parse object:", error)
		return {}
	}
}
...
export async function convertToAnthropicMessage(
	...
	if (anthropicRole !== "assistant") {
		throw new Error("OG Assistant <Language Model API>: Only assistant messages are supported.")
	}
