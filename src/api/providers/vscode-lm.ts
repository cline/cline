...
import { ApiHandlerOptions, ModelInfo, openAiModelInfoSaneDefaults, vsCodeLmModels } from "@shared/api"
...
export class VsCodeLmHandler implements ApiHandler, SingleCompletionHandler {
	...
	getModel(): { id: string; info: ModelInfo } {
		if (this.client) {
			...
			const registryEntry = vsCodeLmModels[modelId as keyof typeof vsCodeLmModels]
			if (registryEntry) {
