...
async function performCommitMsgGeneration(stateManager: StateManager, gitDiff: string, inputBox: any) {
	try {
		vscode.commands.executeCommand("setContext", "beadsmith.isGeneratingCommit", true)
		...
		vscode.commands.executeCommand("setContext", "beadsmith.isGeneratingCommit", false)
	}
}
