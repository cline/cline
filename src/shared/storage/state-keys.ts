...
const API_HANDLER_SETTINGS_FIELDS = {
	...
	/** Override for Plan mode region to avoid sync bugs. */
	planVertexRegion: { default: undefined as string | undefined },
	/** Override for Act mode region to avoid sync bugs. */
	actVertexRegion: { default: undefined as string | undefined },
