...
export function convertAutoApprovalSettingsToProto(settings: AutoApprovalSettings): AutoApprovalSettingsRequest {
	return {
		...
		actions: {
			...
			usePromptRefinement: settings.actions.usePromptRefinement || false,
			usePhasePlanning: settings.actions.usePhasePlanning || false,
		},
...
export function convertProtoToAutoApprovalSettings(protoSettings: AutoApprovalSettingsRequest): AutoApprovalSettings {
	return {
		...
		actions: {
			...
			usePromptRefinement: protoSettings.actions?.usePromptRefinement || false,
			usePhasePlanning: protoSettings.actions?.usePhasePlanning || false,
		},
