...
function convertApiProviderToProto(provider: string | undefined): ProtoApiProvider {
	switch (provider) {
		...
		case "synthetic":
			return ProtoApiProvider.SYNTHETIC
		case "dify":
...
function convertProtoToApiProvider(provider: ProtoApiProvider): ApiProvider {
	switch (provider) {
		...
		case ProtoApiProvider.ZAI:
			return "zai"
		case ProtoApiProvider.SYNTHETIC:
			return "synthetic"
...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		planModeSyntheticModelId: config.planModeSyntheticModelId,
		...
		actModeSyntheticModelId: config.actModeSyntheticModelId,
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		syntheticApiKey: protoConfig.syntheticApiKey,
		...
		planModeSyntheticModelId: protoConfig.planModeSyntheticModelId,
		...
		actModeSyntheticModelId: protoConfig.actModeSyntheticModelId,
