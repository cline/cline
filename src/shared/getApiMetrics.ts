import { AiHydroMessage } from "./ExtensionMessage"
...
/**
 * Calculates API metrics from an array of AiHydroMessages.
 *
 ...
 *
 * @param messages - An array of AiHydroMessage objects to process.
