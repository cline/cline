...
export const brainiallModels = {
	"claude-opus-4-6": {
		...
		outputPrice: 25.0,
		cacheWritesPrice: 6.25,
		cacheReadsPrice: 0.50,
		description: "Claude Opus 4.6 — Anthropic's most capable model with extended thinking",
	},
	"claude-sonnet-4-6": {
		maxTokens: 64_000,
		contextWindow: 200_000,
		...
		description: "Claude Sonnet 4.6 — Best balance of speed, cost, and intelligence",
	},
	"claude-haiku-4-5": {
		maxTokens: 8_192,
		contextWindow: 200_000,
		...
		description: "Claude Haiku 4.5 — Fastest Claude model, ideal for high-throughput tasks",
	},
	"claude-opus-4-5": {
		maxTokens: 64_000,
		contextWindow: 200_000,
		...
		cacheWritesPrice: 6.25,
		cacheReadsPrice: 0.50,
		description: "Claude Opus 4.5 — Previous generation premium model",
	},
	"deepseek-r1": {
		maxTokens: 64_000,
		contextWindow: 128_000,
		...
		inputPrice: 1.35,
		outputPrice: 5.40,
		description: "DeepSeek R1 — Open-weight reasoning model with chain-of-thought",
	},
	"deepseek-v3": {
		maxTokens: 8_192,
		contextWindow: 128_000,
		...
		inputPrice: 0.27,
		outputPrice: 1.10,
		description: "DeepSeek V3.2 — Fast and affordable general-purpose model",
	},
	"llama-3.3-70b": {
		maxTokens: 4_096,
		contextWindow: 128_000,
	...
	"nova-pro": {
		...
		inputPrice: 0.80,
		outputPrice: 3.20,
		description: "Amazon Nova Pro — 300K context with image understanding",
	},
	"nova-lite": {
		maxTokens: 8_192,
		contextWindow: 300_000,
		...
		inputPrice: 0.06,
		outputPrice: 0.24,
		description: "Amazon Nova Lite — Ultra-low cost with 300K context",
	},
	"nova-micro": {
		maxTokens: 8_192,
		contextWindow: 128_000,
		...
		inputPrice: 0.035,
		outputPrice: 0.14,
		description: "Amazon Nova Micro — Cheapest model, text only",
	},
	"mistral-large-3": {
		maxTokens: 262_144,
		contextWindow: 262_144,
		...
		inputPrice: 2.0,
		outputPrice: 6.0,
		description: "Mistral Large 3 675B — Mistral's flagship open-weight model",
	},
	"devstral-2": {
		maxTokens: 262_144,
		contextWindow: 262_144,
		...
		inputPrice: 0.40,
		outputPrice: 1.60,
		description: "Devstral 2 123B — Mistral's coding-optimized model",
	},
	"qwen3-80b": {
		maxTokens: 262_000,
		contextWindow: 262_000,
		...
		inputPrice: 0.14,
		outputPrice: 1.40,
		description: "Qwen3 80B MoE — Alibaba's flagship open-weight model",
	},
	"qwen3-32b": {
		maxTokens: 16_384,
		...
		inputPrice: 0.15,
		outputPrice: 0.60,
		description: "Qwen3 32B — Strong mid-size model for coding and reasoning",
	},
	"minimax-m2": {
		maxTokens: 128_000,
		...
		inputPrice: 0.30,
		outputPrice: 1.20,
		description: "MiniMax M2 — Long context model",
	},
	"kimi-k2.5": {
		maxTokens: 256_000,
		contextWindow: 256_000,
		...
		inputPrice: 0.60,
		outputPrice: 3.00,
		description: "Moonshot Kimi K2.5 — Strong reasoning from Moonshot AI",
	},
	"gpt-oss-120b": {
		maxTokens: 4_096,
		contextWindow: 128_000,
		...
		inputPrice: 0.15,
		outputPrice: 0.60,
		description: "GPT OSS 120B — OpenAI's open-source model",
	},
} as const satisfies Record<string, ModelInfo>
