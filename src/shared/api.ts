...
export type GithHubCopilotModelId = keyof typeof githHubCopilotModels
export const githHubCopilotDefaultModelId: GithHubCopilotModelId = "gpt-4"
export const githHubCopilotModels = {
	"gpt-3.5-turbo": {
		maxTokens: 12114,
		contextWindow: 12114,
		supportsImages: false,
