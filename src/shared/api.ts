...
export const groqModels = {
	...
	"llama-3.1-8b-instant": {
		...
		inputPrice: 0.05,
		outputPrice: 0.08,
		description: "Fast and efficient Llama 3.1 8B model optimized for speed and low latency.",
	},
	// Llama 3 Models
	"llama3-70b-8192": {
		maxTokens: 8192,
		...
		inputPrice: 0.59,
		outputPrice: 0.79,
		description: "Meta's Llama 3 70B model with 8K context window for general tasks.",
	},
	"llama3-8b-8192": {
		maxTokens: 8192,
		contextWindow: 8192,
		...
		inputPrice: 0.05,
		outputPrice: 0.08,
		description: "Meta's Llama 3 8B model with 8K context window, fast and efficient.",
	},
	// Llama Guard Models
	"meta-llama/llama-guard-4-12b": {
		...
		inputPrice: 0.2,
		outputPrice: 0.2,
		description: "Meta's Llama Guard 4 12B model for content moderation with 128K context window.",
	},
	"llama-guard-3-8b": {
		maxTokens: 8192,
		contextWindow: 8192,
		...
		inputPrice: 0.2,
		outputPrice: 0.2,
		description: "Meta's Llama Guard 3 8B model for content moderation and safety.",
	},
	// DeepSeek Models
	"deepseek-r1-distill-llama-70b": {
		maxTokens: 8192,
		...
		inputPrice: 0.75,
		outputPrice: 0.99,
		description: "DeepSeek R1 distilled into Llama 70B architecture for enhanced reasoning capabilities.",
	},
	// Qwen Models
	"qwen-qwq-32b": {
		maxTokens: 32768,
		...
		inputPrice: 0.29,
		outputPrice: 0.39,
		description: "Qwen QwQ 32B model with 128K context window, optimized for question-answering tasks.",
	},
	// Mistral Models
	"mistral-saba-24b": {
		maxTokens: 32768,
		...
		inputPrice: 0.79,
		outputPrice: 0.79,
		description: "Mistral's Saba 24B model with balanced performance and efficiency.",
	},
	// Google Models
	"gemma2-9b-it": {
		maxTokens: 8192,
		...
		inputPrice: 0.2,
		outputPrice: 0.2,
		description: "Google's Gemma 2 9B instruction-tuned model with good performance for various tasks.",
	},
	...
	"compound-beta": {
		...
		inputPrice: 0.0,
		outputPrice: 0.0,
		description: "Llama 4 Scout for core reasoning along with Llama 3.3 70B to help with routing and tool use.",
	},
	"compound-beta-mini": {
		maxTokens: 8192,
		contextWindow: 8192,
	...
	"allam-2-7b": {
		...
		inputPrice: 0.0,
		outputPrice: 0.0,
		description: "Language model designed to advance Arabic Language Technology (ALT).",
	},
} as const satisfies Record<string, ModelInfo>
