...
export interface BannerCardData {
	...
	/** Only show to Beadsmith users */
	isBeadsmithUserOnly?: boolean
}
...
export const BANNER_DATA: BannerCardData[] = [
	// ChatGPT integration banner
	{
		...
		icon: "megaphone",
		title: "Use ChatGPT with Beadsmith",
		description:
			"Bring your ChatGPT subscription to Beadsmith! Use your existing plan directly with no per token costs or API keys to manage.",
		actions: [
			{
				title: "Connect",
	...
	// Info banner with inline link
	{
		id: "info-banner-v1",
		icon: "lightbulb",
		title: "Use Beadsmith in Right Sidebar",
		description:
			"For the best experience, drag the Beadsmith icon to your right sidebar. This keeps your file explorer and editor visible while you chat with Beadsmith, making it easier to navigate your codebase and see changes in real-time. [See how →](https://docs.cline.bot/features/customization/opening-cline-in-sidebar)",
	},
]
