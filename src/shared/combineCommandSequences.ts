...
/**
 * Combines sequences of command and command_output messages in an array of PostHogMessages.
 *
 * This function processes an array of PostHogMessages objects, looking for sequences
 ...
 * @returns A new array of PostHogMessage objects with command sequences combined.
 *
 * @example
 * const messages: PostHogMessage[] = [
 ...
 */
export function combineCommandSequences(messages: PostHogMessage[]): PostHogMessage[] {
    const combinedCommands: PostHogMessage[] = []
