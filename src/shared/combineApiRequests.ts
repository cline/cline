import { PostHogMessage } from './ExtensionMessage'

/**
 * Combines API request start and finish messages in an array of PostHogMessages.
 *
 ...
 * @returns A new array of PostHogMessage objects with API requests combined.
 *
 * @example
 * const messages = [
