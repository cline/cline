...
/**
 * Combines API request start and finish messages in an array of BeadsmithMessages.
 *
 ...
 * @returns A new array of BeadsmithMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: BeadsmithMessage[]): BeadsmithMessage[] {
	const combinedApiRequests: BeadsmithMessage[] = []
