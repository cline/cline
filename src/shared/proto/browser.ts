...
function createBaseGetBrowserConnectionInfoRequest(): GetBrowserConnectionInfoRequest {
	return {}
}

export const GetBrowserConnectionInfoRequest: MessageFns<GetBrowserConnectionInfoRequest> = {
	encode(_: GetBrowserConnectionInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
		return writer
	},

	decode(input: BinaryReader | Uint8Array, length?: number): GetBrowserConnectionInfoRequest {
		const reader = input instanceof BinaryReader ? input : new BinaryReader(input)
		let end = length === undefined ? reader.len : reader.pos + length
		const message = createBaseGetBrowserConnectionInfoRequest()
	...
	create<I extends Exact<DeepPartial<GetBrowserConnectionInfoRequest>, I>>(base?: I): GetBrowserConnectionInfoRequest {
		return GetBrowserConnectionInfoRequest.fromPartial(base ?? ({} as any))
	},
	fromPartial<I extends Exact<DeepPartial<GetBrowserConnectionInfoRequest>, I>>(_: I): GetBrowserConnectionInfoRequest {
		const message = createBaseGetBrowserConnectionInfoRequest()
		return message
	},
}
