 ...
 * GitOperations Class
 *
 * Handles git-specific operations for AI-Hydro's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "AI Hydro Checkpoint")
		await git.addConfig("user.email", "checkpoint@aihydro.bot")
