...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		try {
			...
			throw new Error("Checkpoint git intitialization failed")
		}
		...
		try {
			...
			throw new Error("Failed to write exclude file for shadow git repository")
		}
		...
		try {
			...
			throw new Error("Failed to create initial commit in shadow git repository")
		}
