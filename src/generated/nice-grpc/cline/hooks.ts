...
export const HookModelContext: MessageFns<HookModelContext> = {
  ...
  create(base?: DeepPartial<HookModelContext>): HookModelContext {
    return HookModelContext.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<HookModelContext>): HookModelContext {
    const message = createBaseHookModelContext();
...
export const NotificationData: MessageFns<NotificationData> = {
  ...
  create(base?: DeepPartial<NotificationData>): NotificationData {
    return NotificationData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<NotificationData>): NotificationData {
    const message = createBaseNotificationData();
