...
export const UiServiceService = {
  ...
  scrollToSettings: {
    ...
    responseSerialize: (value: KeyValuePair): Buffer => Buffer.from(KeyValuePair.encode(value).finish()),
    responseDeserialize: (value: Buffer): KeyValuePair => KeyValuePair.decode(value),
  },
  /** Sets the terminal execution mode (vscodeTerminal or backgroundExec) */
  setTerminalExecutionMode: {
  ...
  /** Subscribe to worktrees button clicked events */
  subscribeToWorktreesButtonClicked: {
    path: "/cline.UiService/subscribeToWorktreesButtonClicked",
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  subscribeToPartialMessage: {
    ...
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: ClineMessage): Buffer => Buffer.from(ClineMessage.encode(value).finish()),
    responseDeserialize: (value: Buffer): ClineMessage => ClineMessage.decode(value),
  },
  /** Initialize webview when it launches */
  initializeWebview: {
  ...
  subscribeToShowWebview: {
    ...
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: ShowWebviewEvent): Buffer => Buffer.from(ShowWebviewEvent.encode(value).finish()),
    responseDeserialize: (value: Buffer): ShowWebviewEvent => ShowWebviewEvent.decode(value),
  },
  /** Returns the HTML for the webview index page. This is only used by external clients, not by the vscode webview. */
  getWebviewHtml: {
...
export interface UiServiceServer extends UntypedServiceImplementation {
  ...
  /** Subscribe to worktrees button clicked events */
  subscribeToWorktreesButtonClicked: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Subscribe to partial message updates (streaming Cline messages as they're built) */
...
export interface UiServiceClient extends Client {
  ...
  /** Subscribe to worktrees button clicked events */
  subscribeToWorktreesButtonClicked(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<Empty>;
  subscribeToWorktreesButtonClicked(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
