...
export const EnvServiceService = {
  ...
  getTelemetrySettings: {
    ...
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: GetTelemetrySettingsResponse): Buffer =>
      Buffer.from(GetTelemetrySettingsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetTelemetrySettingsResponse => GetTelemetrySettingsResponse.decode(value),
  },
  /** Returns events when the telemetry settings change. */
  subscribeToTelemetrySettings: {
    ...
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: TelemetrySettingsEvent): Buffer =>
      Buffer.from(TelemetrySettingsEvent.encode(value).finish()),
    responseDeserialize: (value: Buffer): TelemetrySettingsEvent => TelemetrySettingsEvent.decode(value),
  },
  /** Initiates a graceful shutdown of the host bridge service. */
  shutdown: {
   ...
   */
  openExternal: {
    path: "/host.EnvService/openExternal",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
...
export interface EnvServiceServer extends UntypedServiceImplementation {
  ...
  /** Logs a debug message to the host environment's log/output console. */
  debugLog: handleUnaryCall<StringRequest, Empty>;
  /**
   * Opens an external URL in the default browser.
   * In remote environments (VS Code Server, SSH, etc.), this routes the URL
   * to the user's local machine to open in their local browser.
   */
  openExternal: handleUnaryCall<StringRequest, Empty>;
}
...
export interface EnvServiceClient extends Client {
  ...
  /** Logs a debug message to the host environment's log/output console. */
  debugLog(request: StringRequest, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
  debugLog(
    request: StringRequest,
    metadata: Metadata,
    callback: (error: ServiceError | null, response: Empty) => void,
