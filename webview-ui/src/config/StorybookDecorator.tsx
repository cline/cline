...
const BeadsmithAuthProviderWithOverrides: React.FC<{
	overrides?: Partial<BeadsmithAuthContextType>
	children: React.ReactNode
}> = ({ overrides, children }) => {
	const authContext = useBeadsmithAuth()
...
export const createStorybookDecorator =
	...
	(Story: any) => (
		<ExtensionStateProviderWithOverrides overrides={overrideStates}>
			...
			</BeadsmithAuthProviderWithOverrides>
