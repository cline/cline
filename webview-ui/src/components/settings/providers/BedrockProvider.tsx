import { bedrockDefaultModelId, bedrockModels, CLAUDE_SONNET_4_5_1M_SUFFIX } from "@shared/api"
			...
			{showModelOptions && (
				<>
					...
					{(selectedModelId === "anthropic.claude-3-7-sonnet-20250219-v1:0" ||
						...
						selectedModelId === `anthropic.claude-sonnet-4-5-20250929-v1:0${CLAUDE_SONNET_4_5_1M_SUFFIX}` ||
						...
						(modeFields.awsBedrockCustomSelected &&
							modeFields.awsBedrockCustomModelBaseId === "aanthropic.claude-sonnet-4-20250514-v1:0") ||
						(modeFields.awsBedrockCustomSelected &&
							modeFields.awsBedrockCustomModelBaseId === "anthropic.claude-sonnet-4-5-20250929-v1:0") ||
						(modeFields.awsBedrockCustomSelected &&
							modeFields.awsBedrockCustomModelBaseId ===
								`anthropic.claude-sonnet-4-5-20250929-v1:0${CLAUDE_SONNET_4_5_1M_SUFFIX}`) ||
						(modeFields.awsBedrockCustomSelected &&
