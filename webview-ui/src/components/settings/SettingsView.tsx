...
const SettingsView = ({ onDone }: SettingsViewProps) => {
    ...
    */
	...
	return (
		<div className="fixed top-0 left-0 right-0 bottom-0 pt-[10px] pr-0 pb-0 pl-[20px] flex flex-col overflow-hidden">
			...
			<div className="grow overflow-y-scroll pr-2 flex flex-col">
				...
				<div className="mt-auto pr-2 flex justify-center">
					<SettingsButton onClick={() => vscode.postMessage({ type: "openExtensionSettings" })} className="m-0 mb-4">
						<i className="codicon codicon-settings-gear" />
						Advanced Settings
					</SettingsButton>
				</div>
				<div className="text-center text-[var(--vscode-descriptionForeground)] text-xs leading-[1.2] px-0 py-0 pr-2 pb-[15px]">
