		...
		<div>
			...
			<Section>
				<div className="flex px-4 flex-col gap-2">
					<h2 className="text-lg font-semibold">Clink v{version}</h2>
					<p>
						An AI assistant that can use your CLI and Editor. Clink can handle complex software development tasks
