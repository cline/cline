				...
				<div className="mb-5" id="terminal-settings-section">
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground)">
							When enabled, Cline will reuse compatible background terminals between commands to reduce process
							startup overhead. Disable this if you suspect terminal reuse is causing command isolation issues.
						</p>
					</div>
