...
interface SettingsSliderProps {
	...
	valueWidth?: string
	/** Optional formatter for the displayed value. If omitted, the raw number is shown. */
	...
	return (
		<div>
			<div className="flex items-center justify-between gap-4">
				...
				<span className={`text-sm font-mono text-foreground ${valueWidth} text-right`}>{displayValue}</span>
			</div>
