...
│   ├── OpenAINativeProvider.tsx      # OpenAI native API configuration
...
└── __tests__/                   # Tests
    └── ApiOptions.test.tsx     # Tests for ApiOptions component
```
...
5. Update tests to include the new provider
...
Each provider component should be tested in isolation to ensure it renders correctly and handles user input properly. The ApiOptions.test.tsx file demonstrates how to test the main component with different providers.
