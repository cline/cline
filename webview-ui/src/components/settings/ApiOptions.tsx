...
import { FeatherlessProvider } from "./providers/FeatherlessProvider"
		...
		<div style={{ display: "flex", flexDirection: "column", gap: 5, marginBottom: isPopup ? -10 : 0 }}>
			<DropdownContainer className="dropdown-container">
				...
				<VSCodeDropdown
					...
					<VSCodeOption value="featherless">Featherless</VSCodeOption>
				</VSCodeDropdown>
			</DropdownContainer>
			...
			{apiConfiguration && selectedProvider === "featherless" && (
				<FeatherlessProvider showModelOptions={showModelOptions} isPopup={isPopup} currentMode={currentMode} />
			)}
