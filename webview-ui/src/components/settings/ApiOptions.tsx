        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 5, marginBottom: isPopup ? -10 : 0 }}>
            ...
            {selectedProvider === 'qwen' && (
                <div>
                    ...
                    >
                        Please select the appropriate API interface based on your location. If you are in China, choose
                        the China API interface. Otherwise, choose the International API interface.
                    </p>
                    <VSCodeTextField
            ...
            {selectedProvider === 'bedrock' && (
                ...
                >
                    ...
                    >
                        {apiConfiguration?.awsUseProfile ? (
                            <>
                                Using AWS Profile credentials from ~/.aws/credentials. Leave profile name empty to use
                                the default profile. These credentials are only used locally to make API requests from
                                this extension.
                            </>
                        ) : (
                            <>
                                Authenticate by either providing the keys above or use the default AWS credential
                                providers, i.e. ~/.aws/credentials or environment variables. These credentials are only
                                used locally to make API requests from this extension.
                            </>
                        )}
                    </p>
                </div>
                ...
                <div>
                    ...
                    >
                        <span style={{ color: 'var(--vscode-errorForeground)' }}>
                            (<span style={{ fontWeight: 500 }}>Note:</span> PostHog uses complex prompts and works best
                    ...
                    <DropdownContainer zIndex={DROPDOWN_Z_INDEX - 2} className="dropdown-container">
                        ...
                        {vsCodeLmModels.length > 0 ? (
                            ...
                            >
                                ...
                                is to install the Copilot extension from the VS Marketplace and enabling Claude 3.7
                                Sonnet.
                            </p>
                        )}
            ...
            {selectedProvider === 'xai' && (
                <div>
                    ...
                    {/* Note: To fully implement this, you would need to add a handler in PostHogProvider.ts */}
                    {/* {apiConfiguration?.xaiApiKey && (
						<button
							onClick={() => {
								vscode.postMessage({
...
export function getOpenRouterAuthUrl(uriScheme?: string) {
    return `https://openrouter.ai/auth?callback_url=${uriScheme || 'vscode'}://posthog.posthog-extension/openrouter`
}
