...
// TODO: Re-enable when click-to-set-threshold is released
...
const ContextWindow: React.FC<ContextWindowProgressProps> = ({
	...
	// TODO: Finish implementing click-to-set-threshold when auto-condense UI is fully released.
	// Currently disabled because accidental clicks silently set very low thresholds, causing
	// aggressive context compaction (e.g., every 3 exchanges instead of at ~150K tokens).
	// Re-enable when 1m context models (sonnet/opus :1m variants) are more reliable and
	// the threshold interaction has proper UX (confirmation, visual feedback, undo).
	...
	// TODO: Finish implementing keyboard threshold adjustment when auto-condense UI is fully released.
	// Disabled alongside click handler — see handleContextWindowBarClick comment above.
						...
						<HoverCard>
							...
							<HoverCardTrigger asChild>
								{/* TODO: Re-add role="slider", aria-value*, onKeyDown, onClick, and tabIndex
								    when click-to-set-threshold is re-enabled. See commented-out handlers above. */}
								<div
