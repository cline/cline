		...
		case "say":
			switch (message.say) {
				...
				case "reasoning": {
					...
					const reasoningMessages = clineMessages.filter((m: ClineMessage) => m.type === "say" && m.say === "reasoning")

					const currentReasoningIndex = reasoningMessages.findIndex((m: ClineMessage) => m.ts === message.ts)
									...
									{isExpanded ? (
										<div>
											<div
												...
												<VSCodeBadge style={{ fontSize: "11px", padding: "2px 5px" }}>
													<span
														className="codicon codicon-symbol-parameter"
														style={{ marginRight: "3px", fontSize: "10px" }}></span>
										...
										<div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
											<div style={{ display: "flex", alignItems: "center", maxWidth: "75%" }}>
												<span
													className="codicon codicon-lightbulb"
													style={{ marginRight: "6px", flexShrink: 0 }}></span>
