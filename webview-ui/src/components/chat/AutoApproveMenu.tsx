        ...
        >
            ...
            {isExpanded && (
                <div style={{ padding: '0' }}>
                    ...
                    >
                        Auto-approve allows PostHog to perform the following actions without asking for permission.
                        Please use with caution and only enable if you understand the risks.
                    </div>
                    ...
                    >
                        PostHog will automatically make this many API requests before asking for approval to proceed
                        with the task.
                    </div>
