			...
			<div>
				...
				{isExpanded && (
					<Button
						...
						<div
							className={cn(
								"flex max-h-[150px] overflow-y-auto text-description leading-normal truncated whitespace-pre-wrap break-words flex-1 [scrollbar-width:none] [-ms-overflow-style:none] pl-2 border-l border-description/50 [&::-webkit-scrollbar]:hidden [direction:ltr]",
								{
									"ml-4": !showIcon,
								},
							)}
