...
const Announcement = ({ version, hideAnnouncement }: AnnouncementProps) => {
	...
	return (
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				<li>
					<b>Caching in:</b> You asked for Caching, we delivered.  Gemini and Vertex providers have more robust
					caching.  We also added cache tracking for these providers.
				</li>
				<li>
					<b>Checkpoints:</b> We added checkpoints to more message responses.  Restore from more than just file changes.
				</li>
				<li>
					<b>Copy Buttons:</b> Buttons were added to Markdown and Code blocks that allow you to copy their contents easily.
				</li>
				<li>
