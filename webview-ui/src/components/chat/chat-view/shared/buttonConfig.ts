...
export const BUTTON_CONFIGS: Record<string, ButtonConfig> = {
	...
	api_req_failed: {
		...
		enableButtons: true,
		primaryText: "chatView.retry",
		secondaryText: "chatView.startNewTask",
		primaryAction: "retry",
	...
	mistake_limit_reached: {
		...
		enableButtons: true,
		primaryText: "chatView.proceedAnyways",
		secondaryText: "chatView.startNewTask",
	...
	tool_approve: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "chatView.approve",
		secondaryText: "chatView.reject",
	...
	command: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "chatView.runCommand",
		secondaryText: "chatView.reject",
		primaryAction: "approve",
		secondaryAction: "reject",
	},
	command_output: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "chatView.proceedWhileRunning",
	...
	completion_result: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "chatView.startNewTask",
		secondaryText: undefined,
	...
	resume_task: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "chatView.resumeTask",
		secondaryText: undefined,
		primaryAction: "proceed",
		secondaryAction: undefined,
	},
	...
	new_task: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "chatView.startNewTaskWithContext",
		secondaryText: undefined,
		primaryAction: "new_task",
		secondaryAction: undefined,
	},
	...
	condense: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "chatView.condenseConversation",
		secondaryText: undefined,
	...
	report_bug: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "chatView.reportGitHubIssue",
		secondaryText: undefined,
		primaryAction: "utility",
		secondaryAction: undefined,
	},
