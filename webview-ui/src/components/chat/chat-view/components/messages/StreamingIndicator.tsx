...
/**
 * Component that determines and displays streaming state
 * Handles API request streaming, partial messages, and cancellation states
 */
export const StreamingIndicator: React.FC<StreamingIndicatorProps> = ({
	...
	// It's used to encapsulate the streaming logic
	return null
}
