	...
	({ className, children, hideClose = false, ...props }, ref) => (
		<DialogPortal>
			...
			<DialogPrimitive.Content
				className={cn(
					"fixed left-[50%] top-[35%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-35%] gap-4 border border-input-placeholder/20 bg-background p-3 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:rounded-lg",
					className,
				)}
				ref={ref}
				{...props}>
