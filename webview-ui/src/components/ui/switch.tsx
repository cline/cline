...
>(({ className, ...props }, ref) => (
	<SwitchPrimitives.Root
		...
		<SwitchPrimitives.Thumb
			className={cn(
				"pointer-events-none block h-3 w-3 rounded-full bg-button-foreground/80 shadow-lg transition-transform data-[state=checked]:translate-x-2.5 data-[state=unchecked]:translate-x-0",
			)}
		/>
	</SwitchPrimitives.Root>
))
