...
export const CODE_BLOCK_BG_COLOR = "var(--ai-hydro-surface, var(--vscode-editor-background, rgb(30 41 59)))"

export const TERMINAL_CODE_BLOCK_BG_COLOR = "var(--ai-hydro-background, var(--vscode-editor-background, rgb(15 23 42)))"

// Theme-aware background colors for expanded/collapsed states
export const CHAT_ROW_EXPANDED_BG_COLOR = "var(--ai-hydro-surface, var(--vscode-editor-background))"
export const CHAT_ROW_COLLAPSED_BG_COLOR = "var(--ai-hydro-background, var(--vscode-sideBar-background))"
