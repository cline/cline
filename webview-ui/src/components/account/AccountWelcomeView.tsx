	...
	return (
		<div className="flex flex-col items-center pr-3 gap-2.5">
			...
			<p className="text-(--vscode-descriptionForeground) text-xs text-center m-0">
				...
				<VSCodeLink href="https://cline.bot/tos">{t("account.welcome.terms_of_service")}</VSCodeLink>{" "}
				{t("account.welcome.and")}{" "}
				<VSCodeLink href="https://cline.bot/privacy">{t("account.welcome.privacy_policy")}</VSCodeLink>.
			</p>
		</div>
	)
}
