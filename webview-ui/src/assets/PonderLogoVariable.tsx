...
/**
 * PonderLogoVariable component renders the Ponder logo with automatic theme adaptation.
 *
 ...
 * @returns {JSX.Element} SVG Ponder logo that adapts to VS Code themes
 */
const PonderLogoVariable = (props: SVGProps<SVGSVGElement>) => (
...
export default PonderLogoVariable
