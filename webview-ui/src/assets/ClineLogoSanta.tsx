...
const ClineLogoSanta = (props: SVGProps<SVGSVGElement> & { environment?: Environment }) => {
	...
	return (
		<svg height="50" viewBox="0 0 66.62 63.92" width="47" xmlns="http://www.w3.org/2000/svg" {...svgProps}>
			...
			<path
				d="M57.49,17.46,60.4,14.63c-.14-.01-.21-.13-.27-.26-1.43-2.96-1.52-3.53-4.67-6.86S43.99-.26,33.66.78c-2.51.25-7.99,1.46-11.38,4.92s-6.13,3.78-7.64,8.29c-.27.8-.39,1.63-.63,2.23-.03.07-.08.13-.15.16-.71.36-1.12.58-1.22.65-1.31.91-2.08,2.19-2.29,3.84-.21,1.66-.37,2.93-.46,3.83-.2,1.91.39,3.41,1.77,4.5.87.69,1.93,1.02,3.19,1,7.26-.11,17.5.8,24.77,2.02,3.06.51,7.39,1.35,10.98,2.27,2.81.72,5.38-1.13,5.75-3.96.24-1.81.41-3.27.53-4.39.17-1.75-.43-2.98-1.51-4.22-.07-.08-.11-.18-.11-.29-.01-.44,0-.9.02-1.38.08-1.87-1.1-3.89-1.4-5.9,0-.07.06-.1.12-.09,6.03,1.05,4.91,1.28,4.56,1.91"
				fill="#DC2626"
			/>
